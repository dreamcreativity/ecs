...
function(window, document, undefined) {
        ...
        return ErrorConstructor = ErrorConstructor || Error,
            function() {
                ...
                for (message += template.replace(/\{\d+\}/g, function(match) {
                    ...
                    }), message += "\nhttp://errors.angularjs.org/1.4.0/" + (module ? module + "/" : "") + code, i = SKIP_INDEXES, paramPrefix = "?"; i < templateArgs.length; i++, paramPrefix = "&") message += paramPrefix + "p" + (i - SKIP_INDEXES) + "=" + encodeURIComponent(toDebugString(templateArgs[i]));
        ...
        if (destination) {
            ...
            if (isArray(source)) {
                ...
                if (isArray(destination) ? destination.length = 0 : forEach(destination, function(value, key) {
                    ...
                    }), isBlankObject(source))
                    for (key in source) putValue(key, source[key], destination, stackSource, stackDest);
                else if (source && "function" == typeof source.hasOwnProperty)
                    for (key in source) source.hasOwnProperty(key) && putValue(key, source[key], destination, stackSource, stackDest);
                else
                    for (key in source) hasOwnProperty.call(source, key) && putValue(key, source[key], destination, stackSource, stackDest);
        ...
        this.$get = ["$window", "$timeout", function($window, $timeout) {
            ...
            function queueFn(asyncFn) {
                ...
                return taskCount++, taskQueue.push(asyncFn), 0 === index && (cancelLastRAF = rafFn(flush)),
                    function() {
                        index >= 0 && (taskQueue[index] = null, index = null, 0 === --taskCount && cancelLastRAF && (cancelLastRAF(), cancelLastRAF = null, taskQueue.length = 0))
                    }
            }
        ...
        $$CoreAnimateQueueProvider = function() {
            ...
            this.$get = ["$$AnimateRunner", "$rootScope", function($$AnimateRunner, $rootScope) {
                function addRemoveClassesPostDigest(element, add, remove) {
                    ...
                    data || (postDigestQueue.put(element, data = {}), postDigestElements.push(element)), add && forEach(add.split(" "), function(className) {
        ...
        ngOptionsDirective = ["$compile", "$parse", function($compile, $parse) {
            function parseOptionsExpression(optionsExp, selectElement, scope) {
                ...
                return {
                    ...
                    getOptions: function() {
                        var optionValuesKeys, optionItems = [],
                            selectValueMap = {},
                            ...
                            $scope.$watchCollection(rhs, function(collection) {
                                ...
                                for (var blockKey in lastBlockMap) {
                                    if (block = lastBlockMap[blockKey], elementsToRemove = getBlockNodes(block.clone),
                                        $animate.leave(elementsToRemove), elementsToRemove[0].parentNode)
    ...
    function(root, factory) {
        "function" == typeof define && define.amd ? define("simple-module", ["jquery"], function(a0) {
            return root.Module = factory(a0)
        }) : "object" == typeof exports ? module.exports = factory(require("jquery")) : root.SimpleModule = factory(jQuery)
    }(this, function($) {
        var Module, slice = [].slice;
        return Module = function() {
            function Module(opts) {
                var base, cls, i, instance, instances, len, name;
                if (this.opts = $.extend({}, this.opts, opts), (base = this.constructor)._connectedClasses || (base._connectedClasses = []), instances = function() {
                        var i, len, ref, results;
                        for (ref = this.constructor._connectedClasses, results = [], i = 0, len = ref.length; len > i; i++) cls = ref[i], name = cls.pluginName.charAt(0).toLowerCase() + cls.pluginName.slice(1), cls.prototype._connected && (cls.prototype._module = this), results.push(this[name] = new cls);
                        return results
                    }.call(this), this._connected) this.opts = $.extend({}, this.opts, this._module.opts);
                else
                    for (this._init(), i = 0, len = instances.length; len > i; i++) instance = instances[i], "function" == typeof instance._init && instance._init();
                this.trigger("initialized")
            }
            return Module.extend = function(obj) {
                var key, ref, val;
                if (null != obj && "object" == typeof obj) {
                    for (key in obj) val = obj[key], "included" !== key && "extended" !== key && (this[key] = val);
                    return null != (ref = obj.extended) ? ref.call(this) : void 0
                }
            }, Module.include = function(obj) {
                var key, ref, val;
                if (null != obj && "object" == typeof obj) {
                    for (key in obj) val = obj[key], "included" !== key && "extended" !== key && (this.prototype[key] = val);
                    return null != (ref = obj.included) ? ref.call(this) : void 0
                }
            }, Module.connect = function(cls) {
                if ("function" == typeof cls) {
                    if (!cls.pluginName) throw new Error("Module.connect: cannot connect plugin without pluginName");
                    return cls.prototype._connected = !0, this._connectedClasses || (this._connectedClasses = []), this._connectedClasses.push(cls), cls.pluginName ? this[cls.pluginName] = cls : void 0
                }
            }, Module.prototype.opts = {}, Module.prototype._init = function() {}, Module.prototype.on = function() {
                var args, ref;
                return args = 1 <= arguments.length ? slice.call(arguments, 0) : [], (ref = $(this)).on.apply(ref, args), this
            }, Module.prototype.one = function() {
                var args, ref;
                return args = 1 <= arguments.length ? slice.call(arguments, 0) : [], (ref = $(this)).one.apply(ref, args), this
            }, Module.prototype.off = function() {
                var args, ref;
                return args = 1 <= arguments.length ? slice.call(arguments, 0) : [], (ref = $(this)).off.apply(ref, args), this
            }, Module.prototype.trigger = function() {
                var args, ref;
                return args = 1 <= arguments.length ? slice.call(arguments, 0) : [], (ref = $(this)).trigger.apply(ref, args), this
            }, Module.prototype.triggerHandler = function() {
                var args, ref;
                return args = 1 <= arguments.length ? slice.call(arguments, 0) : [], (ref = $(this)).triggerHandler.apply(ref, args)
            }, Module.prototype._t = function() {
                var args, ref;
                return args = 1 <= arguments.length ? slice.call(arguments, 0) : [], (ref = this.constructor)._t.apply(ref, args)
            }, Module._t = function() {
                var args, key, ref, result;
                return key = arguments[0], args = 2 <= arguments.length ? slice.call(arguments, 1) : [], result = (null != (ref = this.i18n[this.locale]) ? ref[key] : void 0) || "", args.length > 0 ? (result = result.replace(/([^%]|^)%(?:(\d+)\$)?s/g, function(p0, p, position) {
                    return position ? p + args[parseInt(position) - 1] : p + args.shift()
                }), result.replace(/%%s/g, "%s")) : result
            }, Module.i18n = {
                "en-US": {}
            }, Module.locale = "en-US", Module
        }()
    }),
    function(root, factory) {
        "function" == typeof define && define.amd ? define("simple-hotkeys", ["jquery", "simple-module"], function($, SimpleModule) {
            return root.hotkeys = factory($, SimpleModule)
        }) : "object" == typeof exports ? module.exports = factory(require("jquery"), require("simple-module")) : (root.simple = root.simple || {}, root.simple.hotkeys = factory(jQuery, SimpleModule))
        ...
        return Hotkeys = function(superClass) {
            function Hotkeys() {
                return Hotkeys.__super__.constructor.apply(this, arguments)
            }
            return extend(Hotkeys, superClass), Hotkeys.count = 0, Hotkeys.keyNameMap = {
                8: "Backspace",
                9: "Tab",
                13: "Enter",
                16: "Shift",
                ...
                for (keys = shortcut.toLowerCase().replace(/\s+/gi, "").split("+"), i = j = 0, len = keys.length; len > j; i = ++j) key = keys[i], keys[i] = this.aliases[key] || key;
                return keyname = keys.pop(), keys.sort().push(keyname), keys.join("_")
            }, Hotkeys.prototype.opts = {
                el: document
            }, Hotkeys.prototype._init = function() {
                return this.id = ++this.constructor.count, this._map = {}, this._delegate = "string" == typeof this.opts.el ? document : this.opts.el, $(this._delegate).on("keydown.simple-hotkeys-" + this.id, this.opts.el, function(_this) {
                    return function(e) {
                        var ref;
                        return null != (ref = _this._getHander(e)) ? ref.call(_this, e) : void 0
                    }
                }(this))
            }, Hotkeys.prototype._getHander = function(e) {
                var keyname, shortcut;
                if (keyname = this.constructor.keyNameMap[e.which]) return shortcut = "", e.altKey && (shortcut += "alt_"), e.ctrlKey && (shortcut += "control_"), e.metaKey && (shortcut += "meta_"), e.shiftKey && (shortcut += "shift_"), shortcut += keyname.toLowerCase(), this._map[shortcut]
            }, Hotkeys.prototype.respondTo = function(subject) {
                return "string" == typeof subject ? null != this._map[this.constructor.normalize(subject)] : null != this._getHander(subject)
            }, Hotkeys.prototype.add = function(shortcut, handler) {
                return this._map[this.constructor.normalize(shortcut)] = handler, this
            }, Hotkeys.prototype.remove = function(shortcut) {
                return delete this._map[this.constructor.normalize(shortcut)], this
            }, Hotkeys.prototype.destroy = function() {
                return $(this._delegate).off(".simple-hotkeys-" + this.id), this._map = {}, this
            }, Hotkeys
        }(SimpleModule), hotkeys = function(opts) {
            return new Hotkeys(opts)
        }
    }),
    function(root, factory) {
        "function" == typeof define && define.amd ? define("simple-uploader", ["jquery", "simple-module"], function($, SimpleModule) {
            return root.uploader = factory($, SimpleModule)
        }) : "object" == typeof exports ? module.exports = factory(require("jquery"), require("simple-module")) : (root.simple = root.simple || {}, root.simple.uploader = factory(jQuery, SimpleModule))
    }(this, function($, SimpleModule) {
        var Uploader, uploader, extend = function(child, parent) {
            ...
            hasProp = {}.hasOwnProperty;
        return Uploader = function(superClass) {
            function Uploader() {
                return Uploader.__super__.constructor.apply(this, arguments)
            }
            return extend(Uploader, superClass), Uploader.count = 0, Uploader.prototype.opts = {
                url: "",
                params: null,
                fileKey: "upload_file",
                connectionCount: 3
            }, Uploader.prototype._init = function() {
                return this.files = [], this.queue = [], this.id = ++Uploader.count, this.on("uploadcomplete", function(_this) {
                    return function(e, file) {
                        return _this.files.splice($.inArray(file, _this.files), 1), _this.queue.length > 0 && _this.files.length < _this.opts.connectionCount ? _this.upload(_this.queue.shift()) : _this.uploading = !1
                    }
                }(this)), $(window).on("beforeunload.uploader-" + this.id, function(_this) {
                    return function(e) {
                        return _this.uploading ? (e.originalEvent.returnValue = _this._t("leaveConfirm"), _this._t("leaveConfirm")) : void 0
                    }
                }(this))
                ...
                var f, i, key, len;
                if (null == opts && (opts = {}), null != file) {
                    if ($.isArray(file) || file instanceof FileList)
                        for (i = 0, len = file.length; len > i; i++) f = file[i], this.upload(f, opts);
                    else $(file).is("input:file") ? (key = $(file).attr("name"), key && (opts.fileKey = key), this.upload($.makeArray($(file)[0].files), opts)) : file.id && file.obj || (file = this.getFile(file));
                    if (file && file.obj) {
                        if ($.extend(file, opts), this.files.length >= this.opts.connectionCount) return void this.queue.push(file);
                        if (this.triggerHandler("beforeupload", [file]) !== !1) return this.files.push(file), this._xhrUpload(file), this.uploading = !0
                    }
                }
            }, Uploader.prototype.getFile = function(fileObj) {
                var name, ref, ref1;
                return fileObj instanceof window.File || fileObj instanceof window.Blob ? (name = null != (ref = fileObj.fileName) ? ref : fileObj.name, {
                    id: this.generateId(),
                    url: this.opts.url,
                    params: this.opts.params,
                    fileKey: this.opts.fileKey,
                    name: name,
                    size: null != (ref1 = fileObj.fileSize) ? ref1 : fileObj.size,
                    ext: name ? name.split(".").pop().toLowerCase() : "",
                    obj: fileObj
                }) : null
            }, Uploader.prototype._xhrUpload = function(file) {
                var formData, k, ref, v;
                if (formData = new FormData, formData.append(file.fileKey, file.obj), formData.append("original_filename", file.name), file.params) {
                    ref = file.params;
                    for (k in ref) v = ref[k], formData.append(k, v)
                }
                return file.xhr = $.ajax({
                    ...
                    xhr: function() {
                        var req;
                        return req = $.ajaxSettings.xhr(), req && (req.upload.onprogress = function(_this) {
                            return function(e) {
                    ...
                    progress: function(_this) {
                        return function(e) {
                            return e.lengthComputable ? _this.trigger("uploadprogress", [file, e.loaded, e.total]) : void 0
                        }
                    }(this),
                    ...
                    success: function(_this) {
                        return function(result) {
                            return _this.trigger("uploadprogress", [file, file.size, file.size]), _this.trigger("uploadsuccess", [file, result]), $(document).trigger("uploadsuccess", [file, result, _this])
                        }
                    }(this),
                ...
                var f, i, len, ref;
                if (!file.id)
                    for (ref = this.files, i = 0, len = ref.length; len > i; i++)
                        if (f = ref[i], f.id === 1 * file) {
                            file = f;
                            break
                        }
                return this.trigger("uploadcancel", [file]), file.xhr && file.xhr.abort(), file.xhr = null
            }, Uploader.prototype.readImageFile = function(fileObj, callback) {
                var fileReader, img;
                if ($.isFunction(callback)) return img = new Image, img.onload = function() {
                    return callback(img)
                }, img.onerror = function() {
                    return callback()
                }, window.FileReader && FileReader.prototype.readAsDataURL && /^image/.test(fileObj.type) ? (fileReader = new FileReader, fileReader.onload = function(e) {
                    return img.src = e.target.result
                }, fileReader.readAsDataURL(fileObj)) : callback()
            }, Uploader.prototype.destroy = function() {
                var file, i, len, ref;
                for (this.queue.length = 0, ref = this.files, i = 0, len = ref.length; len > i; i++) file = ref[i], this.cancel(file);
                return $(window).off(".uploader-" + this.id), $(document).off(".uploader-" + this.id)
            }, Uploader.i18n = {
                "zh-CN": {
                    leaveConfirm: "正在上传文件，如果离开上传会自动取消"
                }
            }, Uploader.locale = "zh-CN", Uploader
        }(SimpleModule), uploader = function(opts) {
            return new Uploader(opts)
        }
    }),
    function(root, factory) {
        "function" == typeof define && define.amd ? define("simditor", ["jquery", "simple-module", "simple-hotkeys", "simple-uploader"], function($, SimpleModule, simpleHotkeys, simpleUploader) {
            return root.Simditor = factory($, SimpleModule, simpleHotkeys, simpleUploader)
        }) : "object" == typeof exports ? module.exports = factory(require("jquery"), require("simple-module"), require("simple-hotkeys"), require("simple-uploader")) : root.Simditor = factory(jQuery, SimpleModule, simple.hotkeys, simple.uploader)
        ...
        var AlignmentButton, BlockquoteButton, BoldButton, Button, CodeButton, CodePopover, ColorButton, Formatter, HrButton, ImageButton, ImagePopover, IndentButton, Indentation, InputManager, ItalicButton, Keystroke, LinkButton, LinkPopover, ListButton, OrderListButton, OutdentButton, Popover, Selection, Simditor, StrikethroughButton, TableButton, TitleButton, Toolbar, UnderlineButton, UndoManager, UnorderListButton, Util, extend = function(child, parent) {
            ...
            slice = [].slice;
        return Selection = function(superClass) {
            function Selection() {
                return Selection.__super__.constructor.apply(this, arguments)
            }
            return extend(Selection, superClass), Selection.pluginName = "Selection", Selection.prototype._init = function() {
                ...
                return this.clear(), this.sel.addRange(range), this.editor.inputManager.focused || !this.editor.util.browser.firefox && !this.editor.util.browser.msie || this.editor.body.focus(), range
            }, Selection.prototype.rangeAtEndOf = function(node, range) {
                var endNode, endNodeLength, result;
                return null == range && (range = this.getRange()), null != range && range.collapsed ? (node = $(node)[0], endNode = range.endContainer, endNodeLength = this.editor.util.getNodeLength(endNode), range.endOffset === endNodeLength - 1 && $(endNode).contents().last().is("br") || range.endOffset === endNodeLength ? node === endNode ? !0 : $.contains(node, endNode) ? (result = !0, $(endNode).parentsUntil(node).addBack().each(function(_this) {
                    return function(i, n) {
                        var $lastChild, nodes;
                        return nodes = $(n).parent().contents().filter(function() {
                            return !(this !== n && 3 === this.nodeType && !this.nodeValue)
                        }), $lastChild = nodes.last(), $lastChild.get(0) === n || $lastChild.is("br") && $lastChild.prev().get(0) === n ? void 0 : (result = !1, !1)
                    }
                }(this)), result) : !1 : !1) : void 0
            }, Selection.prototype.rangeAtStartOf = function(node, range) {
                var result, startNode;
                return null == range && (range = this.getRange()), null != range && range.collapsed ? (node = $(node)[0], startNode = range.startContainer, 0 !== range.startOffset ? !1 : node === startNode ? !0 : $.contains(node, startNode) ? (result = !0, $(startNode).parentsUntil(node).addBack().each(function(_this) {
                    return function(i, n) {
                        var nodes;
                        return nodes = $(n).parent().contents().filter(function() {
                            return !(this !== n && 3 === this.nodeType && !this.nodeValue)
                        }), nodes.first().get(0) !== n ? result = !1 : void 0
                    }
                }(this)), result) : !1) : void 0
            }, Selection.prototype.insertNode = function(node, range) {
                return null == range && (range = this.getRange()), null != range ? (node = $(node)[0], range.insertNode(node), this.setRangeAfter(node, range)) : void 0
            }, Selection.prototype.setRangeAfter = function(node, range) {
                return null == range && (range = this.getRange()), null != range ? (node = $(node)[0], range.setEndAfter(node), range.collapse(!1), this.selectRange(range)) : void 0
            }, Selection.prototype.setRangeBefore = function(node, range) {
                return null == range && (range = this.getRange()), null != range ? (node = $(node)[0], range.setEndBefore(node), range.collapse(!1), this.selectRange(range)) : void 0
            }, Selection.prototype.setRangeAtStartOf = function(node, range) {
                return null == range && (range = this.getRange()), node = $(node).get(0), range.setEnd(node, 0), range.collapse(!1), this.selectRange(range)
            }, Selection.prototype.setRangeAtEndOf = function(node, range) {
                var $lastNode, $node, contents, lastChild, lastText, nodeLength;
                return null == range && (range = this.getRange()), $node = $(node), node = $node.get(0), $node.is("pre") ? (contents = $node.contents(), contents.length > 0 ? (lastChild = contents.last(), lastText = lastChild.text(), "\n" === lastText.charAt(lastText.length - 1) ? range.setEnd(lastChild[0], this.editor.util.getNodeLength(lastChild[0]) - 1) : range.setEnd(lastChild[0], this.editor.util.getNodeLength(lastChild[0]))) : range.setEnd(node, 0)) : (nodeLength = this.editor.util.getNodeLength(node), 3 !== node.nodeType && nodeLength > 0 && ($lastNode = $(node).contents().last(), $lastNode.is("br") ? nodeLength -= 1 : 3 !== $lastNode[0].nodeType && this.editor.util.isEmptyNode($lastNode) && ($lastNode.append(this.editor.util.phBr), node = $lastNode[0], nodeLength = 0)), range.setEnd(node, nodeLength)), range.collapse(!1), this.selectRange(range)
            }, Selection.prototype.deleteRangeContents = function(range) {
                var endRange, startRange;
                return null == range && (range = this.getRange()), startRange = range.cloneRange(), endRange = range.cloneRange(), startRange.collapse(!0), endRange.collapse(!1), !range.collapsed && this.rangeAtStartOf(this.editor.body, startRange) && this.rangeAtEndOf(this.editor.body, endRange) ? (this.editor.body.empty(), range.setStart(this.editor.body[0], 0), range.collapse(!0), this.selectRange(range)) : range.deleteContents(), range
            }, Selection.prototype.breakBlockEl = function(el, range) {
                var $el;
                return null == range && (range = this.getRange()), $el = $(el), range.collapsed ? (range.setStartBefore($el.get(0)), range.collapsed ? $el : $el.before(range.extractContents())) : $el
            }, Selection.prototype.save = function(range) {
                var endCaret, endRange, startCaret;
                return null == range && (range = this.getRange()), this._selectionSaved ? void 0 : (endRange = range.cloneRange(), endRange.collapse(!1), startCaret = $("<span/>").addClass("simditor-caret-start"), endCaret = $("<span/>").addClass("simditor-caret-end"), endRange.insertNode(endCaret[0]), range.insertNode(startCaret[0]), this.clear(), this._selectionSaved = !0)
            }, Selection.prototype.restore = function() {
                var endCaret, endContainer, endOffset, range, startCaret, startContainer, startOffset;
                return this._selectionSaved ? (startCaret = this.editor.body.find(".simditor-caret-start"), endCaret = this.editor.body.find(".simditor-caret-end"), startCaret.length && endCaret.length ? (startContainer = startCaret.parent(), startOffset = startContainer.contents().index(startCaret), endContainer = endCaret.parent(), endOffset = endContainer.contents().index(endCaret), startContainer[0] === endContainer[0] && (endOffset -= 1), range = document.createRange(), range.setStart(startContainer.get(0), startOffset), range.setEnd(endContainer.get(0), endOffset), startCaret.remove(), endCaret.remove(), this.selectRange(range)) : (startCaret.remove(), endCaret.remove()), this._selectionSaved = !1, range) : !1
            }, Selection
        }(SimpleModule), Formatter = function(superClass) {
            function Formatter() {
                return Formatter.__super__.constructor.apply(this, arguments)
            }
            return extend(Formatter, superClass), Formatter.pluginName = "Formatter", Formatter.prototype.opts = {
                allowedTags: null,
                ...
                return null == $el && ($el = this.editor.body), this.editor.trigger("decorate", [$el])
            }, Formatter.prototype.undecorate = function($el) {
                return null == $el && ($el = this.editor.body.clone()), this.editor.trigger("undecorate", [$el]), $.trim($el.html())
            }, Formatter.prototype.autolink = function($el) {
                var $node, findLinkNode, j, lastIndex, len, linkNodes, match, re, replaceEls, text, uri;
                for (null == $el && ($el = this.editor.body), linkNodes = [], findLinkNode = function($parentNode) {
                        return $parentNode.contents().each(function(i, node) {
                            var $node, text;
                            return $node = $(node), $node.is("a") || $node.closest("a, pre", $el).length ? void 0 : $node.contents().length ? findLinkNode($node) : (text = $node.text()) && /https?:\/\/|www\./gi.test(text) ? linkNodes.push($node) : void 0
                        })
                    }, findLinkNode($el), re = /(https?:\/\/|www\.)[\w\-\.\?&=\/#%:,@\!\+]+/gi, j = 0, len = linkNodes.length; len > j; j++) {
                    for ($node = linkNodes[j], text = $node.text(), replaceEls = [], match = null, lastIndex = 0; null !== (match = re.exec(text));) replaceEls.push(document.createTextNode(text.substring(lastIndex, match.index))), lastIndex = re.lastIndex, uri = /^(http(s)?:\/\/|\/)/.test(match[0]) ? match[0] : "http://" + match[0], replaceEls.push($('<a href="' + uri + '" rel="nofollow"></a>').text(match[0])[0]);
                    replaceEls.push(document.createTextNode(text.substring(lastIndex))), $node.replaceWith($(replaceEls))
                }
                return $el
            }, Formatter.prototype.format = function($el) {
                var $node, blockNode, j, k, len, len1, n, node, ref, ref1;
                if (null == $el && ($el = this.editor.body), $el.is(":empty")) return $el.append("<p>" + this.editor.util.phBr + "</p>"), $el;
                for (ref = $el.contents(), j = 0, len = ref.length; len > j; j++) n = ref[j], this.cleanNode(n, !0);
                for (ref1 = $el.contents(), k = 0, len1 = ref1.length; len1 > k; k++) node = ref1[k], $node = $(node), $node.is("br") ? ("undefined" != typeof blockNode && null !== blockNode && (blockNode = null), $node.remove()) : this.editor.util.isBlockNode(node) ? $node.is("li") ? blockNode && blockNode.is("ul, ol") ? blockNode.append(node) : (blockNode = $("<ul/>").insertBefore(node), blockNode.append(node)) : blockNode = null : ((!blockNode || blockNode.is("ul, ol")) && (blockNode = $("<p/>").insertBefore(node)), blockNode.append(node));
                return $el
                ...
                if ($node = $(node), $node.length > 0) {
                    if (3 === $node[0].nodeType) return text = $node.text().replace(/(\r\n|\n|\r)/gm, ""), void(text ? (textNode = document.createTextNode(text),
                        $node.replaceWith(textNode)) : $node.remove());
                    if (contents = $node.contents(), isDecoration = $node.is('[class^="simditor-"]'), $node.is(this._allowedTags.join(",")) || isDecoration) {
                        if ($node.is("a") && ($childImg = $node.find("img")).length > 0 && ($node.replaceWith($childImg), $node = $childImg, contents = null), $node.is("img") && $node.hasClass("uploading") && $node.remove(), !isDecoration)
                            for (allowedAttributes = this._allowedAttributes[$node[0].tagName.toLowerCase()], ref = $.makeArray($node[0].attributes), j = 0, len = ref.length; len > j; j++) attr = ref[j], null != allowedAttributes && (ref1 = attr.name, indexOf.call(allowedAttributes, ref1) >= 0) || $node.removeAttr(attr.name)
                    } else 1 !== $node[0].nodeType || $node.is(":empty") ? ($node.remove(), contents = null) : $node.is("div, article, dl, header, footer, tr") ? ($node.append("<br/>"), contents.first().unwrap()) : $node.is("table") ? ($p = $("<p/>"), $node.find("tr").each(function(_this) {
                        return function(i, tr) {
                            return $p.append($(tr).text() + "<br/>")
                        }
                    }(this)), $node.replaceWith($p), contents = null) : $node.is("thead, tfoot") ? ($node.remove(), contents = null) : $node.is("th") ? ($td = $("<td/>").append($node.contents()), $node.replaceWith($td)) : contents.first().unwrap();
                    if (recursive && null != contents && !$node.is("pre"))
                        for (k = 0, len1 = contents.length; len1 > k; k++) n = contents[k], this.cleanNode(n, !0);
                    return null
                }
            }, Formatter.prototype.clearHtml = function(html, lineBreak) {
                var container, contents, result;
                return null == lineBreak && (lineBreak = !0), container = $("<div/>").append(html), contents = container.contents(), result = "", contents.each(function(_this) {
                    return function(i, node) {
                        var $node, children;
                        return 3 === node.nodeType ? result += node.nodeValue : 1 === node.nodeType && ($node = $(node), children = $node.contents(), children.length > 0 && (result += _this.clearHtml(children)), lineBreak && i < contents.length - 1 && $node.is("br, p, div, li, tr, pre, address, artticle, aside, dl, figcaption, footer, h1, h2, h3, h4, header")) ? result += "\n" : void 0
                    }
                }(this)), result
            }, Formatter.prototype.beautify = function($contents) {
                var uselessP;
                return uselessP = function($el) {
                    return !!($el.is("p") && !$el.text() && $el.children(":not(br)").length < 1)
                }, $contents.each(function(_this) {
                    return function(i, el) {
                        var $el;
                        return $el = $(el), $el.is(':not(img, br, col, td, hr, [class^="simditor-"]):empty') && $el.remove(), uselessP($el) && $el.remove(), $el.find(':not(img, br, col, td, hr, [class^="simditor-"]):empty').remove()
                    }
                }(this))
            }, Formatter
        }(SimpleModule), InputManager = function(superClass) {
            function InputManager() {
                return InputManager.__super__.constructor.apply(this, arguments)
            }
            return extend(InputManager, superClass), InputManager.pluginName = "InputManager", InputManager.prototype.opts = {
                pasteImage: !1
            }, InputManager.prototype._modifierKeys = [16, 17, 18, 91, 93, 224], InputManager.prototype._arrowKeys = [37, 38, 39, 40], InputManager.prototype._init = function() {
                var submitKey;
                return this.editor = this._module, this.throttledTrigger = this.editor.util.throttle(function(_this) {
                    return function() {
                        var args;
                        return args = 1 <= arguments.length ? slice.call(arguments, 0) : [], setTimeout(function() {
                            var ref;
                            return (ref = _this.editor).trigger.apply(ref, args)
                        }, 10)
                    }
                }(this), 300), this.opts.pasteImage && "string" != typeof this.opts.pasteImage && (this.opts.pasteImage = "inline"), this._keystrokeHandlers = {}, this.hotkeys = simpleHotkeys({
                    el: this.editor.body
                    ...
                    tabIndex: "-1",
                    contentEditable: !0
                }).addClass("simditor-paste-area").appendTo(this.editor.el), $(document).on("selectionchange.simditor" + this.editor.id, function(_this) {
                    return function(e) {
                        return _this.focused ? (_this._selectionTimer && (clearTimeout(_this._selectionTimer), _this._selectionTimer = null), _this._selectionTimer = setTimeout(function() {
                            return _this.editor.trigger("selectionchanged")
                        }, 20)) : void 0
                    }
                }(this)), this.editor.on("valuechanged", function(_this) {
                    return function() {
                        return !_this.editor.util.closestBlockEl() && _this.focused && (_this.editor.selection.save(), _this.editor.formatter.format(), _this.editor.selection.restore()), _this.editor.body.find("hr, pre, .simditor-table").each(function(i, el) {
                            var $el, formatted;
                            return $el = $(el), ($el.parent().is("blockquote") || $el.parent()[0] === _this.editor.body[0]) && (formatted = !1, 0 === $el.next().length && ($("<p/>").append(_this.editor.util.phBr).insertAfter($el), formatted = !0), 0 === $el.prev().length && ($("<p/>").append(_this.editor.util.phBr).insertBefore($el), formatted = !0), formatted) ? setTimeout(function() {
                                return _this.editor.trigger("valuechanged")
                            }, 10) : void 0
                        }), _this.editor.body.find("pre:empty").append(_this.editor.util.phBr), !_this.editor.util.support.onselectionchange && _this.focused ? _this.editor.trigger("selectionchanged") : void 0
                    }
                }(this)), this.editor.on("selectionchanged", function(_this) {
                    return function(e) {
                        return _this.editor.undoManager.update()
                    }
                }(this)), this.editor.body.on("keydown", $.proxy(this._onKeyDown, this)).on("keypress", $.proxy(this._onKeyPress, this)).on("keyup", $.proxy(this._onKeyUp, this)).on("mouseup", $.proxy(this._onMouseUp, this)).on("focus", $.proxy(this._onFocus, this)).on("blur", $.proxy(this._onBlur, this)).on("paste", $.proxy(this._onPaste, this)).on("drop", $.proxy(this._onDrop, this)).on("input", $.proxy(this._onInput, this)), this.editor.util.browser.firefox && (this.addShortcut("cmd+left", function(_this) {
                    return function(e) {
                        return e.preventDefault(), _this.editor.selection.sel.modify("move", "backward", "lineboundary"), !1
                    }
                }(this)), this.addShortcut("cmd+right", function(_this) {
                    return function(e) {
                        return e.preventDefault(), _this.editor.selection.sel.modify("move", "forward", "lineboundary"), !1
                    }
                }(this)), this.addShortcut(this.editor.util.os.mac ? "cmd+a" : "ctrl+a", function(_this) {
                    return function(e) {
                        var $children, firstBlock, lastBlock, range;
                        return $children = _this.editor.body.children(), $children.length > 0 ? (firstBlock = $children.first().get(0), lastBlock = $children.last().get(0), range = document.createRange(), range.setStart(firstBlock, 0), range.setEnd(lastBlock, _this.editor.util.getNodeLength(lastBlock)), _this.editor.selection.selectRange(range), !1) : void 0
                    }
                }(this))), submitKey = this.editor.util.os.mac ? "cmd+enter" : "ctrl+enter", this.addShortcut(submitKey, function(_this) {
                    return function(e) {
                        return _this.editor.el.closest("form").find("button:submit").click(), !1
                    }
                }(this)), this.editor.textarea.attr("autofocus") ? setTimeout(function(_this) {
                    return function() {
                        return _this.editor.focus()
                    }
                }(this), 0) : void 0
            }, InputManager.prototype._onFocus = function(e) {
                return this.editor.el.addClass("focus").removeClass("error"), this.focused = !0, this.lastCaretPosition = null, setTimeout(function(_this) {
                    return function() {
                        return _this.editor.triggerHandler("focus"), _this.editor.trigger("selectionchanged")
                    }
                }(this), 0)
            }, InputManager.prototype._onBlur = function(e) {
                var ref;
                return this.editor.el.removeClass("focus"), this.editor.sync(), this.focused = !1, this.lastCaretPosition = null != (ref = this.editor.undoManager.currentState()) ? ref.caret : void 0, this.editor.triggerHandler("blur")
            }, InputManager.prototype._onMouseUp = function(e) {
                return this.editor.util.support.onselectionchange ? void 0 : setTimeout(function(_this) {
                    return function() {
                        return _this.editor.trigger("selectionchanged")
                    }
                }(this), 0)
                ...
                if (!this.hotkeys.respondTo(e)) {
                    if (e.which in this._keystrokeHandlers) {
                        if (result = "function" == typeof(base = this._keystrokeHandlers[e.which])["*"] ? base["*"](e) : void 0) return this.editor.trigger("valuechanged"), !1;
                        if (this.editor.util.traverseUp(function(_this) {
                                return function(node) {
                                    var handler, ref;
                                    if (node.nodeType === document.ELEMENT_NODE) return handler = null != (ref = _this._keystrokeHandlers[e.which]) ? ref[node.tagName.toLowerCase()] : void 0, result = "function" == typeof handler ? handler(e, $(node)) : void 0, result === !0 || result === !1 ? !1 : void 0
                                }
                            }(this)), result) return this.editor.trigger("valuechanged"), !1
                    }
                    if (ref = e.which, !(indexOf.call(this._modifierKeys, ref) >= 0 || (ref1 = e.which, indexOf.call(this._arrowKeys, ref1) >= 0) || this.editor.util.metaKey(e) && 86 === e.which)) return this.editor.util.support.oninput || this.throttledTrigger("valuechanged", ["typing"]), null
                }
            }, InputManager.prototype._onKeyPress = function(e) {
                return this.editor.triggerHandler(e) === !1 ? !1 : void 0
            }, InputManager.prototype._onKeyUp = function(e) {
                var p, ref;
                return this.editor.triggerHandler(e) === !1 ? !1 : !this.editor.util.support.onselectionchange && (ref = e.which, indexOf.call(this._arrowKeys, ref) >= 0) ? void this.editor.trigger("selectionchanged") : void(8 !== e.which && 46 !== e.which || !this.editor.util.isEmptyNode(this.editor.body) || (this.editor.body.empty(), p = $("<p/>").append(this.editor.util.phBr).appendTo(this.editor.body), this.editor.selection.setRangeAtStartOf(p)))
                ...
                if (this.editor.triggerHandler(e) === !1) return !1;
                if (range = this.editor.selection.deleteRangeContents(), range.collapsed || range.collapse(!0), $blockEl = this.editor.util.closestBlockEl(), cleanPaste = $blockEl.is("pre, table"), e.originalEvent.clipboardData && e.originalEvent.clipboardData.items && e.originalEvent.clipboardData.items.length > 0 && (pasteItem = e.originalEvent.clipboardData.items[0], /^image\//.test(pasteItem.type) && !cleanPaste)) {
                    if (imageFile = pasteItem.getAsFile(), null == imageFile || !this.opts.pasteImage) return;
                    return imageFile.name || (imageFile.name = "Clipboard Image.png"), uploadOpt = {}, uploadOpt[this.opts.pasteImage] = !0, null != (ref = this.editor.uploader) && ref.upload(imageFile, uploadOpt), !1
                }
                return processPasteContent = function(_this) {
                    return function(pasteContent) {
                        ...
                        if (_this.editor.triggerHandler("pasting", [pasteContent]) !== !1 && pasteContent) {
                            if (cleanPaste)
                                if ($blockEl.is("table")) {
                                    for (lines = pasteContent.split("\n"), lastLine = lines.pop(), j = 0, len = lines.length; len > j; j++) line = lines[j], _this.editor.selection.insertNode(document.createTextNode(line)), _this.editor.selection.insertNode($("<br/>"));
                                    _this.editor.selection.insertNode(document.createTextNode(lastLine))
                                } else
                                    for (pasteContent = $("<div/>").text(pasteContent), ref1 = pasteContent.contents(), k = 0, len1 = ref1.length; len1 > k; k++) node = ref1[k], _this.editor.selection.insertNode($(node)[0], range);
                            else if ($blockEl.is(_this.editor.body))
                                for (l = 0, len2 = pasteContent.length; len2 > l; l++) node = pasteContent[l], _this.editor.selection.insertNode(node, range);
                            else {
                                if (pasteContent.length < 1) return;
                                if (1 === pasteContent.length)
                                    if (pasteContent.is("p")) {
                                        if (children = pasteContent.contents(), 1 === children.length && children.is("img")) {
                                            if ($img = children, /^data:image/.test($img.attr("src"))) {
                                                if (!_this.opts.pasteImage) return;
                                                return blob = _this.editor.util.dataURLtoBlob($img.attr("src")), blob.name = "Clipboard Image.png", uploadOpt = {}, uploadOpt[_this.opts.pasteImage] = !0, void(null != (ref2 = _this.editor.uploader) && ref2.upload(blob, uploadOpt))
                                            }
                                            if ($img.is('img[src^="webkit-fake-url://"]')) return
                                        }
                                        for (m = 0, len3 = children.length; len3 > m; m++) node = children[m], _this.editor.selection.insertNode(node, range)
                                    } else if ($blockEl.is("p") && _this.editor.util.isEmptyNode($blockEl)) $blockEl.replaceWith(pasteContent), _this.editor.selection.setRangeAtEndOf(pasteContent, range);
                                else if (pasteContent.is("ul, ol"))
                                    if (1 === pasteContent.find("li").length)
                                        for (pasteContent = $("<div/>").text(pasteContent.text()), ref3 = pasteContent.contents(), o = 0, len4 = ref3.length; len4 > o; o++) node = ref3[o], _this.editor.selection.insertNode($(node)[0], range);
                                    else $blockEl.is("li") ? ($blockEl.parent().after(pasteContent), _this.editor.selection.setRangeAtEndOf(pasteContent, range)) : ($blockEl.after(pasteContent), _this.editor.selection.setRangeAtEndOf(pasteContent, range));
                                else $blockEl.after(pasteContent), _this.editor.selection.setRangeAtEndOf(pasteContent, range);
                                else $blockEl.is("li") && ($blockEl = $blockEl.parent()), _this.editor.selection.rangeAtStartOf($blockEl, range) ? insertPosition = "before" : _this.editor.selection.rangeAtEndOf($blockEl, range) ? insertPosition = "after" : (_this.editor.selection.breakBlockEl($blockEl, range), insertPosition = "before"), $blockEl[insertPosition](pasteContent), _this.editor.selection.setRangeAtEndOf(pasteContent.last(), range)
                            }
                            return _this.editor.trigger("valuechanged")
                        }
                    }
                }(this), cleanPaste ? (e.preventDefault(), pasteContent = this.editor.util.browser.msie ? window.clipboardData.getData("Text") : e.originalEvent.clipboardData.getData("text/plain"), processPasteContent(pasteContent)) : (this.editor.selection.save(range), this._pasteArea.focus(), this.editor.util.browser.msie && 10 === this.editor.util.browser.version && (e.preventDefault(), this._pasteArea.html(window.clipboardData.getData("Text"))), setTimeout(function(_this) {
                    return function() {
                        return _this._pasteArea.is(":empty") ? pasteContent = null : (pasteContent = $("<div/>").append(_this._pasteArea.contents()), pasteContent.find("table colgroup").remove(), _this.editor.formatter.format(pasteContent), _this.editor.formatter.decorate(pasteContent), _this.editor.formatter.beautify(pasteContent.children()), pasteContent = pasteContent.contents()), _this._pasteArea.empty(), range = _this.editor.selection.restore(), processPasteContent(pasteContent)
                    }
                }(this), 10))
            }, InputManager.prototype._onDrop = function(e) {
                return this.editor.triggerHandler(e) === !1 ? !1 : setTimeout(function(_this) {
                    return function() {
                        return _this.editor.trigger("valuechanged")
                    }
                }(this), 0)
                ...
                return this._keystrokeHandlers[key] || (this._keystrokeHandlers[key] = {}), this._keystrokeHandlers[key][node] = handler
            }, InputManager.prototype.addShortcut = function(keys, handler) {
                return this.hotkeys.add(keys, $.proxy(handler, this))
            }, InputManager
        }(SimpleModule), Keystroke = function(superClass) {
            function Keystroke() {
                return Keystroke.__super__.constructor.apply(this, arguments)
            }
            return extend(Keystroke, superClass), Keystroke.pluginName = "Keystroke", Keystroke.prototype._init = function() {
                var titleEnterHandler;
                return this.editor = this._module, this.editor.util.browser.safari && this.editor.inputManager.addKeystrokeHandler("13", "*", function(_this) {
                    return function(e) {
                        var $blockEl, $br;
                        if (e.shiftKey && ($blockEl = _this.editor.util.closestBlockEl(), !$blockEl.is("pre"))) return $br = $("<br/>"), _this.editor.selection.rangeAtEndOf($blockEl) ? (_this.editor.selection.insertNode($br), _this.editor.selection.insertNode($("<br/>")), _this.editor.selection.setRangeBefore($br)) : _this.editor.selection.insertNode($br), !0
                    }
                }(this)), (this.editor.util.browser.webkit || this.editor.util.browser.msie) && (titleEnterHandler = function(_this) {
                    return function(e, $node) {
                        var $p;
                        if (_this.editor.selection.rangeAtEndOf($node)) return $p = $("<p/>").append(_this.editor.util.phBr).insertAfter($node), _this.editor.selection.setRangeAtStartOf($p), !0
                    }
                }(this), this.editor.inputManager.addKeystrokeHandler("13", "h1", titleEnterHandler), this.editor.inputManager.addKeystrokeHandler("13", "h2", titleEnterHandler), this.editor.inputManager.addKeystrokeHandler("13", "h3", titleEnterHandler), this.editor.inputManager.addKeystrokeHandler("13", "h4", titleEnterHandler), this.editor.inputManager.addKeystrokeHandler("13", "h5", titleEnterHandler), this.editor.inputManager.addKeystrokeHandler("13", "h6", titleEnterHandler)), this.editor.inputManager.addKeystrokeHandler("8", "*", function(_this) {
                    return function(e) {
                        var $blockEl, $prevBlockEl, $rootBlock;
                        return $rootBlock = _this.editor.util.furthestBlockEl(), $prevBlockEl = $rootBlock.prev(), $prevBlockEl.is("hr") && _this.editor.selection.rangeAtStartOf($rootBlock) ? (_this.editor.selection.save(), $prevBlockEl.remove(), _this.editor.selection.restore(), !0) : ($blockEl = _this.editor.util.closestBlockEl(), _this.editor.util.browser.webkit && _this.editor.selection.rangeAtStartOf($blockEl) ? (_this.editor.selection.save(), _this.editor.formatter.cleanNode($blockEl, !0), _this.editor.selection.restore(), null) : void 0)
                    }
                }(this)), this.editor.inputManager.addKeystrokeHandler("13", "li", function(_this) {
                    return function(e, $node) {
                        var $cloneNode, listEl, newBlockEl, newListEl;
                        if ($cloneNode = $node.clone(), $cloneNode.find("ul, ol").remove(), _this.editor.util.isEmptyNode($cloneNode) && $node.is(_this.editor.util.closestBlockEl())) {
                            if (listEl = $node.parent(), $node.next("li").length > 0) {
                                if (!_this.editor.util.isEmptyNode($node)) return;
                                listEl.parent("li").length > 0 ? (newBlockEl = $("<li/>").append(_this.editor.util.phBr).insertAfter(listEl.parent("li")), newListEl = $("<" + listEl[0].tagName + "/>").append($node.nextAll("li")), newBlockEl.append(newListEl)) : (newBlockEl = $("<p/>").append(_this.editor.util.phBr).insertAfter(listEl), newListEl = $("<" + listEl[0].tagName + "/>").append($node.nextAll("li")), newBlockEl.after(newListEl))
                            } else listEl.parent("li").length > 0 ? (newBlockEl = $("<li/>").insertAfter(listEl.parent("li")), $node.contents().length > 0 ? newBlockEl.append($node.contents()) : newBlockEl.append(_this.editor.util.phBr)) : (newBlockEl = $("<p/>").append(_this.editor.util.phBr).insertAfter(listEl), $node.children("ul, ol").length > 0 && newBlockEl.after($node.children("ul, ol")));
                            return $node.prev("li").length ? $node.remove() : listEl.remove(), _this.editor.selection.setRangeAtStartOf(newBlockEl), !0
                        }
                    }
                }(this)), this.editor.inputManager.addKeystrokeHandler("13", "pre", function(_this) {
                    return function(e, $node) {
                        var $p, breakNode, range;
                        return e.preventDefault(), e.shiftKey ? ($p = $("<p/>").append(_this.editor.util.phBr).insertAfter($node), _this.editor.selection.setRangeAtStartOf($p), !0) : (range = _this.editor.selection.getRange(), breakNode = null, range.deleteContents(), !_this.editor.util.browser.msie && _this.editor.selection.rangeAtEndOf($node) ? (breakNode = document.createTextNode("\n\n"), range.insertNode(breakNode), range.setEnd(breakNode, 1)) : (breakNode = document.createTextNode("\n"), range.insertNode(breakNode), range.setStartAfter(breakNode)), range.collapse(!1), _this.editor.selection.selectRange(range), !0)
                    }
                }(this)), this.editor.inputManager.addKeystrokeHandler("13", "blockquote", function(_this) {
                    return function(e, $node) {
                        var $closestBlock, range;
                        return $closestBlock = _this.editor.util.closestBlockEl(), $closestBlock.is("p") && !$closestBlock.next().length && _this.editor.util.isEmptyNode($closestBlock) ? ($node.after($closestBlock), range = document.createRange(), _this.editor.selection.setRangeAtStartOf($closestBlock, range), !0) : void 0
                    }
                }(this)), this.editor.inputManager.addKeystrokeHandler("8", "li", function(_this) {
                    return function(e, $node) {
                        var $br, $childList, $newLi, $prevChildList, $prevNode, $textNode, range, text;
                        return $childList = $node.children("ul, ol"), $prevNode = $node.prev("li"), $childList.length > 0 && $prevNode.length > 0 ? (text = "", $textNode = null, $node.contents().each(function(i, n) {
                            if (1 === n.nodeType && /UL|OL/.test(n.nodeName)) return !1;
                            if (1 !== n.nodeType || !/BR/.test(n.nodeName)) return 3 === n.nodeType && n.nodeValue ? text += n.nodeValue : 1 === n.nodeType && (text += $(n).text()), $textNode = $(n)
                        }), $textNode && 1 === text.length && _this.editor.util.browser.firefox && !$textNode.next("br").length ? ($br = $(_this.editor.util.phBr).insertAfter($textNode), $textNode.remove(), _this.editor.selection.setRangeBefore($br), !0) : text.length > 0 ? !1 : (range = document.createRange(), $prevChildList = $prevNode.children("ul, ol"), $prevChildList.length > 0 ? ($newLi = $("<li/>").append(_this.editor.util.phBr).appendTo($prevChildList), $prevChildList.append($childList.children("li")), $node.remove(), _this.editor.selection.setRangeAtEndOf($newLi, range)) : (_this.editor.selection.setRangeAtEndOf($prevNode, range), $prevNode.append($childList), $node.remove(), _this.editor.selection.selectRange(range)), !0)) : !1
                    }
                }(this)), this.editor.inputManager.addKeystrokeHandler("8", "pre", function(_this) {
                    return function(e, $node) {
                        var $newNode, codeStr, range;
                        if (_this.editor.selection.rangeAtStartOf($node)) return codeStr = $node.html().replace("\n", "<br/>"), $newNode = $("<p/>").append(codeStr || _this.editor.util.phBr).insertAfter($node), $node.remove(), range = document.createRange(), _this.editor.selection.setRangeAtStartOf($newNode, range), !0
                    }
                }(this)), this.editor.inputManager.addKeystrokeHandler("8", "blockquote", function(_this) {
                    return function(e, $node) {
                        var $firstChild, range;
                        if (_this.editor.selection.rangeAtStartOf($node)) return $firstChild = $node.children().first().unwrap(), range = document.createRange(), _this.editor.selection.setRangeAtStartOf($firstChild, range), !0
                    }
                }(this))
            }, Keystroke
        }(SimpleModule), UndoManager = function(superClass) {
            function UndoManager() {
                return UndoManager.__super__.constructor.apply(this, arguments)
            }
            return extend(UndoManager, superClass), UndoManager.pluginName = "UndoManager", UndoManager.prototype._index = -1, UndoManager.prototype._capacity = 50, UndoManager.prototype._timer = null, UndoManager.prototype._init = function() {
                var redoShortcut, undoShortcut;
                return this.editor = this._module, this._stack = [], this.editor.util.os.mac ? (undoShortcut = "cmd+z", redoShortcut = "shift+cmd+z") : this.editor.util.os.win ? (undoShortcut = "ctrl+z", redoShortcut = "ctrl+y") : (undoShortcut = "ctrl+z", redoShortcut = "shift+ctrl+z"), this.editor.inputManager.addShortcut(undoShortcut, function(_this) {
                    return function(e) {
                        return e.preventDefault(), _this.undo(), !1
                    }
                }(this)), this.editor.inputManager.addShortcut(redoShortcut, function(_this) {
                    return function(e) {
                        return e.preventDefault(), _this.redo(), !1
                    }
                }(this)), this.editor.on("valuechanged", function(_this) {
                    return function(e, src) {
                        return "undo" !== src && "redo" !== src ? (_this._timer && (clearTimeout(_this._timer), _this._timer = null), _this._timer = setTimeout(function() {
                            return _this._pushUndoState(), _this._timer = null
                        }, 200)) : void 0
                    }
                }(this))
            }, UndoManager.prototype._pushUndoState = function() {
                var currentState, html;
                if (this.editor.triggerHandler("pushundostate") !== !1 && (currentState = this.currentState(), html = this.editor.body.html(), !currentState || currentState.html !== html)) return this._index += 1, this._stack.length = this._index, this._stack.push({
                    html: html,
                ...
                var state;
                if (!(this._index < 1 || this._stack.length < 2)) return this.editor.hidePopover(), this._index -= 1, state = this._stack[this._index], this.editor.body.html(state.html), this.caretPosition(state.caret), this.editor.body.find(".selected").removeClass("selected"), this.editor.sync(), this.editor.trigger("valuechanged", ["undo"])
            }, UndoManager.prototype.redo = function() {
                var state;
                if (!(this._index < 0 || this._stack.length < this._index + 2)) return this.editor.hidePopover(), this._index += 1, state = this._stack[this._index], this.editor.body.html(state.html), this.caretPosition(state.caret), this.editor.body.find(".selected").removeClass("selected"), this.editor.sync(), this.editor.trigger("valuechanged", ["redo"])
            }, UndoManager.prototype.update = function() {
                var currentState, html;
                if (!this._timer && (currentState = this.currentState())) return html = this.editor.body.html(), currentState.html = html, currentState.caret = this.caretPosition()
            }, UndoManager.prototype._getNodeOffset = function(node, index) {
                var $parent, merging, offset;
                return $parent = index ? $(node) : $(node).parent(), offset = 0, merging = !1, $parent.contents().each(function(_this) {
                    return function(i, child) {
                        return index === i || node === child ? !1 : (3 === child.nodeType ? merging || (offset += 1, merging = !0) : (offset += 1, merging = !1), null)
                    }
                }(this)), offset
            }, UndoManager.prototype._getNodePosition = function(node, offset) {
                var position, prevNode;
                if (3 === node.nodeType)
                    for (prevNode = node.previousSibling; prevNode && 3 === prevNode.nodeType;) node = prevNode, offset += this.editor.util.getNodeLength(prevNode), prevNode = prevNode.previousSibling;
                else offset = this._getNodeOffset(node, offset);
                return position = [], position.unshift(offset), this.editor.util.traverseUp(function(_this) {
                    return function(n) {
                ...
                for (node = this.editor.body[0], ref = position.slice(0, position.length - 1), i = j = 0, len = ref.length; len > j; i = ++j) {
                    if (offset = ref[i], childNodes = node.childNodes, offset > childNodes.length - 1) {
                        if (i !== position.length - 2 || !$(node).is("pre")) {
                            node = null;
                            break
                        }
                        child = document.createTextNode(""), node.appendChild(child), childNodes = node.childNodes
                    }
                ...
                if (caret) {
                    if (this.editor.inputManager.focused || this.editor.body.focus(), !caret.start) return void this.editor.body.blur();
                    if (startContainer = this._getNodeByPosition(caret.start), startOffset = caret.start[caret.start.length - 1], caret.collapsed ? (endContainer = startContainer, endOffset = startOffset) : (endContainer = this._getNodeByPosition(caret.end), endOffset = caret.start[caret.start.length - 1]), !startContainer || !endContainer) throw new Error("simditor: invalid caret state");
                    return range = document.createRange(), range.setStart(startContainer, startOffset), range.setEnd(endContainer, endOffset), this.editor.selection.selectRange(range)
                }
                return range = this.editor.selection.getRange(), this.editor.inputManager.focused && null != range ? (caret = {
                    start: [],
                    end: null,
                    collapsed: !0
                }, caret.start = this._getNodePosition(range.startContainer, range.startOffset), range.collapsed || (caret.end = this._getNodePosition(range.endContainer, range.endOffset), caret.collapsed = !1), caret) : {}
            }, UndoManager
        }(SimpleModule), Util = function(superClass) {
            function Util() {
                return Util.__super__.constructor.apply(this, arguments)
            }
            return extend(Util, superClass), Util.pluginName = "Util", Util.prototype._init = function() {
                return this.editor = this._module, this.browser.msie && this.browser.version < 11 ? this.phBr = "" : void 0
            }, Util.prototype.phBr = "<br/>", Util.prototype.os = function() {
                var os;
                return os = {}, /Mac/.test(navigator.appVersion) ? os.mac = !0 : /Linux/.test(navigator.appVersion) ? os.linux = !0 : /Win/.test(navigator.appVersion) ? os.win = !0 : /X11/.test(navigator.appVersion) && (os.unix = !0), /Mobi/.test(navigator.appVersion) && (os.mobile = !0), os
            }(), Util.prototype.browser = function() {
                var chrome, firefox, ie, ref, ref1, ref2, ref3, safari, ua;
                return ua = navigator.userAgent, ie = /(msie|trident)/i.test(ua), chrome = /chrome|crios/i.test(ua), safari = /safari/i.test(ua) && !chrome, firefox = /firefox/i.test(ua), ie ? {
                    msie: !0,
                    version: 1 * (null != (ref = ua.match(/(msie |rv:)(\d+(\.\d+)?)/i)) ? ref[2] : void 0)
                } : chrome ? {
                    webkit: !0,
                    chrome: !0,
                    version: 1 * (null != (ref1 = ua.match(/(?:chrome|crios)\/(\d+(\.\d+)?)/i)) ? ref1[1] : void 0)
                } : safari ? {
                    webkit: !0,
                    safari: !0,
                    version: 1 * (null != (ref2 = ua.match(/version\/(\d+(\.\d+)?)/i)) ? ref2[1] : void 0)
                } : firefox ? {
                    mozilla: !0,
                    firefox: !0,
                    version: 1 * (null != (ref3 = ua.match(/firefox\/(\d+(\.\d+)?)/i)) ? ref3[1] : void 0)
                } : {}
            }(), Util.prototype.support = function() {
                return {
                    onselectionchange: function() {
                        var e, onselectionchange;
                        if (onselectionchange = document.onselectionchange, void 0 !== onselectionchange) try {
                ...
                return null == el && (el = document), $(el)[0].offsetHeight
            }, Util.prototype.metaKey = function(e) {
                var isMac;
                return isMac = /Mac/.test(navigator.userAgent), isMac ? e.metaKey : e.ctrlKey
            }, Util.prototype.isEmptyNode = function(node) {
                var $node;
                return $node = $(node), $node.is(":empty") || !$node.text() && !$node.find(":not(br, span, div)").length
            }, Util.prototype.blockNodes = ["div", "p", "ul", "ol", "li", "blockquote", "hr", "pre", "h1", "h2", "h3", "h4", "table"], Util.prototype.isBlockNode = function(node) {
                return node = $(node)[0], node && 3 !== node.nodeType ? new RegExp("^(" + this.blockNodes.join("|") + ")$").test(node.nodeName.toLowerCase()) : !1
            }, Util.prototype.closestBlockEl = function(node) {
                var $node, blockEl, range;
                return null == node && (range = this.editor.selection.getRange(), node = null != range ? range.commonAncestorContainer : void 0), $node = $(node), $node.length ? (blockEl = $node.parentsUntil(this.editor.body).addBack(), blockEl = blockEl.filter(function(_this) {
                    return function(i) {
                        return _this.isBlockNode(blockEl.eq(i))
                    }
                }(this)), blockEl.length ? blockEl.last() : null) : null
            }, Util.prototype.furthestNode = function(node, filter) {
                var $node, blockEl, range;
                return null == node && (range = this.editor.selection.getRange(), node = null != range ? range.commonAncestorContainer : void 0), $node = $(node), $node.length ? (blockEl = $node.parentsUntil(this.editor.body).addBack(), blockEl = blockEl.filter(function(_this) {
                    return function(i) {
                        var $n;
                        return $n = blockEl.eq(i), $.isFunction(filter) ? filter($n) : $n.is(filter)
                    }
                }(this)), blockEl.length ? blockEl.first() : null) : null
                ...
                if (null == node && (range = this.editor.selection.getRange(), node = null != range ? range.commonAncestorContainer : void 0), null == node || !$.contains(this.editor.body[0], node)) return !1;
                for (nodes = $(node).parentsUntil(this.editor.body).get(), nodes.unshift(node), results1 = [], j = 0, len = nodes.length; len > j && (n = nodes[j], result = callback(n), result !== !1); j++) results1.push(void 0);
                return results1
                ...
                if (hasBlobConstructor = window.Blob && function() {
                        var e;
                        try {
                    ...
                    }(), BlobBuilder = window.BlobBuilder || window.WebKitBlobBuilder || window.MozBlobBuilder || window.MSBlobBuilder, !((hasBlobConstructor || BlobBuilder) && window.atob && window.ArrayBuffer && window.Uint8Array)) return !1;
                for (byteString = dataURL.split(",")[0].indexOf("base64") >= 0 ? atob(dataURL.split(",")[1]) : decodeURIComponent(dataURL.split(",")[1]), arrayBuffer = new ArrayBuffer(byteString.length), intArray = new Uint8Array(arrayBuffer), i = j = 0, ref = byteString.length; ref >= 0 ? ref >= j : j >= ref; i = ref >= 0 ? ++j : --j) intArray[i] = byteString.charCodeAt(i);
                return mimeString = dataURL.split(",")[0].split(":")[1].split(";")[0], hasBlobConstructor ? new Blob([hasArrayBufferViewSupport ? intArray : arrayBuffer], {
                    type: mimeString
                ...
                return delayedCallTimeout = null, previousCallTime = 0, stopDelayedCall = function() {
                        return delayedCallTimeout ? (clearTimeout(delayedCallTimeout), delayedCallTimeout = null) : void 0
                    },
                    function() {
                        var args, now, remaining, result;
                        return now = Date.now(), previousCallTime || (previousCallTime = now), remaining = wait - (now - previousCallTime), result = null, remaining > 0 && wait > remaining ? (previousCallTime = now, stopDelayedCall(), args = arguments, delayedCallTimeout = setTimeout(function() {
                            return previousCallTime = 0, delayedCallTimeout = null, result = func.apply(null, args)
                        }, wait)) : (stopDelayedCall(), previousCallTime !== now && (previousCallTime = 0), result = func.apply(null, arguments)), result
                    }
            }, Util.prototype.formatHTML = function(html) {
                var cursor, indentString, lastMatch, level, match, re, repeatString, result, str;
                for (re = /<(\/?)(.+?)(\/?)>/g, result = "", level = 0, lastMatch = null, indentString = "  ", repeatString = function(str, n) {
                        return new Array(n + 1).join(str)
                    }; null !== (match = re.exec(html));) match.isBlockNode = $.inArray(match[2], this.blockNodes) > -1, match.isStartTag = "/" !== match[1] && "/" !== match[3], match.isEndTag = "/" === match[1] || "/" === match[3], cursor = lastMatch ? lastMatch.index + lastMatch[0].length : 0, (str = html.substring(cursor, match.index)).length > 0 && $.trim(str) && (result += str), match.isBlockNode && match.isEndTag && !match.isStartTag && (level -= 1), match.isBlockNode && match.isStartTag && (lastMatch && lastMatch.isBlockNode && lastMatch.isEndTag || (result += "\n"), result += repeatString(indentString, level)), result += match[0], match.isBlockNode && match.isEndTag && (result += "\n"), match.isBlockNode && match.isStartTag && (level += 1), lastMatch = match;
                return $.trim(result)
            }, Util
        }(SimpleModule), Toolbar = function(superClass) {
            function Toolbar() {
                return Toolbar.__super__.constructor.apply(this, arguments);
            }
            return extend(Toolbar, superClass), Toolbar.pluginName = "Toolbar", Toolbar.prototype.opts = {
                toolbar: !0,
                toolbarFloat: !0,
                toolbarHidden: !1,
                ...
                var toolbarHeight;
                return this.editor = this._module, this.opts.toolbar ? ($.isArray(this.opts.toolbar) || (this.opts.toolbar = ["bold", "italic", "underline", "strikethrough", "|", "ol", "ul", "blockquote", "code", "|", "link", "image", "|", "indent", "outdent"]), this._render(), this.list.on("click", function(_this) {
                    return function(e) {
                        return !1
                    }
                }(this)), this.wrapper.on("mousedown", function(_this) {
                    return function(e) {
                        return _this.list.find(".menu-on").removeClass(".menu-on")
                    }
                }(this)), $(document).on("mousedown.simditor" + this.editor.id, function(_this) {
                    return function(e) {
                        return _this.list.find(".menu-on").removeClass(".menu-on")
                    }
                }(this)), !this.opts.toolbarHidden && this.opts.toolbarFloat && (this.wrapper.css("top", this.opts.toolbarFloatOffset), toolbarHeight = 0, $(window).on("resize.simditor-" + this.editor.id, function(_this) {
                    return function(e) {
                        return _this.wrapper.css("position", "static"), _this.wrapper.width("auto"), _this.editor.util.reflow(_this.wrapper), _this.wrapper.width(_this.wrapper.outerWidth()), _this.wrapper.css("left", _this.wrapper.offset().left), _this.wrapper.css("position", ""), toolbarHeight = _this.wrapper.outerHeight(), _this.editor.placeholderEl.css("top", toolbarHeight)
                    }
                }(this)).resize(), $(window).on("scroll.simditor-" + this.editor.id, function(_this) {
                    return function(e) {
                        var bottomEdge, scrollTop, topEdge;
                        if (topEdge = _this.editor.wrapper.offset().top, bottomEdge = topEdge + _this.editor.wrapper.outerHeight() - 80, scrollTop = $(document).scrollTop() + _this.opts.toolbarFloatOffset, topEdge >= scrollTop || scrollTop >= bottomEdge) {
                            if (_this.editor.wrapper.removeClass("toolbar-floating").css("padding-top", ""), _this.editor.util.os.mobile) return _this.wrapper.css("top", _this.opts.toolbarFloatOffset)
                        } else if (_this.editor.wrapper.addClass("toolbar-floating").css("padding-top", toolbarHeight), _this.editor.util.os.mobile) return _this.wrapper.css("top", scrollTop - topEdge + _this.opts.toolbarFloatOffset)
                    }
                }(this))), this.editor.on("selectionchanged", function(_this) {
                    return function() {
                        return _this.toolbarStatus()
                    }
                }(this)), this.editor.on("destroy", function(_this) {
                    return function() {
                ...
                var j, len, name, ref;
                for (this.buttons = [], this.wrapper = $(this._tpl.wrapper).prependTo(this.editor.wrapper), this.list = this.wrapper.find("ul"), ref = this.opts.toolbar, j = 0, len = ref.length; len > j; j++)
                    if (name = ref[j], "|" !== name) {
                        if (!this.constructor.buttons[name]) throw new Error('simditor: invalid toolbar button "' + name + '"');
                ...
                var buttons;
                if (this.editor.inputManager.focused) return buttons = this.buttons.slice(0), this.editor.util.traverseUp(function(_this) {
                    return function(node) {
                        var button, i, j, k, len, len1, removeButtons;
                        for (removeButtons = [], i = j = 0, len = buttons.length; len > j; i = ++j) button = buttons[i], (null == name || button.name === name) && (button.status && button.status($(node)) !== !0 || removeButtons.push(button));
                        for (k = 0, len1 = removeButtons.length; len1 > k; k++) button = removeButtons[k], i = $.inArray(button, buttons), buttons.splice(i, 1);
                        return 0 === buttons.length ? !1 : void 0
                    }
                }(this))
            }, Toolbar.prototype.findButton = function(name) {
                var button;
                return button = this.list.find(".toolbar-item-" + name).data("button"), null != button ? button : null
            }, Toolbar.addButton = function(btn) {
                return this.buttons[btn.prototype.name] = btn
            }, Toolbar.buttons = {}, Toolbar
        }(SimpleModule), Indentation = function(superClass) {
            function Indentation() {
                return Indentation.__super__.constructor.apply(this, arguments)
            }
            return extend(Indentation, superClass), Indentation.pluginName = "Indentation", Indentation.prototype.opts = {
                tabIndent: !0
            }, Indentation.prototype._init = function() {
                return this.editor = this._module, this.editor.inputManager.addKeystrokeHandler("9", "*", function(_this) {
                    return function(e) {
                        var codeButton;
                        return codeButton = _this.editor.toolbar.findButton("code"), _this.opts.tabIndent || codeButton && codeButton.active ? _this.indent(e.shiftKey) : void 0
                    }
                }(this))
            }, Indentation.prototype.indent = function(isBackward) {
                var $blockEls, $endBlock, $startBlock, range, result;
                return (range = this.editor.selection.getRange()) ? ($startBlock = this.editor.util.closestBlockEl(range.startContainer), $endBlock = this.editor.util.closestBlockEl(range.endContainer), $startBlock.is("li") && $endBlock.is("li") && $startBlock.parent().is($endBlock.parent()) || ($startBlock = this.editor.util.furthestBlockEl($startBlock), $endBlock = this.editor.util.furthestBlockEl($endBlock)), $blockEls = $startBlock.is($endBlock) ? $startBlock : $startBlock.nextUntil($endBlock).add($startBlock).add($endBlock), result = !1, $blockEls.each(function(_this) {
                ...
                if ($blockEl = $(blockEl), $blockEl.length) {
                    if ($blockEl.is("pre")) {
                        if (range = this.editor.selection.getRange(), $pre = $(range.commonAncestorContainer), !$pre.is($blockEl) && !$pre.closest("pre").is($blockEl)) return;
                        this.indentText(range)
                    } else if ($blockEl.is("li")) {
                        if ($parentLi = $blockEl.prev("li"), $parentLi.length < 1) return;
                        this.editor.selection.save(), tagName = $blockEl.parent()[0].tagName, $childList = $parentLi.children("ul, ol"), $childList.length > 0 ? $childList.append($blockEl) : $("<" + tagName + "/>").append($blockEl).appendTo($parentLi), this.editor.selection.restore()
                    } else if ($blockEl.is("p, h1, h2, h3, h4")) indentLevel = $blockEl.attr("data-indent") || 0, indentLevel = Math.min(1 * indentLevel + 1, 10), $blockEl.attr("data-indent", indentLevel);
                    else if ($blockEl.is("table") || $blockEl.is(".simditor-table")) {
                        if (range = this.editor.selection.getRange(), $td = $(range.commonAncestorContainer).closest("td, th"), $nextTd = $td.next("td, th"), $nextTd.length > 0 || ($tr = $td.parent("tr"), $nextTr = $tr.next("tr"), $nextTr.length < 1 && $tr.parent().is("thead") && ($nextTr = $tr.parent("thead").next("tbody").find("tr:first")), $nextTd = $nextTr.find("td:first, th:first")), !($td.length > 0 && $nextTd.length > 0)) return !1;
                ...
                var text, textNode;
                return text = range.toString().replace(/^(?=.+)/gm, "  "), textNode = document.createTextNode(text || "  "), range.deleteContents(), range.insertNode(textNode), text ? (range.selectNode(textNode), this.editor.selection.selectRange(range)) : this.editor.selection.setRangeAfter(textNode)
            }, Indentation.prototype.outdentBlock = function(blockEl) {
                var $blockEl, $parent, $parentLi, $pre, $prevTd, $prevTr, $td, $tr, button, indentLevel, range, ref;
                if ($blockEl = $(blockEl), $blockEl && $blockEl.length > 0) {
                    if ($blockEl.is("pre")) {
                        if (range = this.editor.selection.getRange(), $pre = $(range.commonAncestorContainer), !$pre.is($blockEl) && !$pre.closest("pre").is($blockEl)) return;
                        this.outdentText(range)
                    } else if ($blockEl.is("li")) {
                        if ($parent = $blockEl.parent(), $parentLi = $parent.parent("li"), $parentLi.length < 1) return button = this.editor.toolbar.findButton($parent[0].tagName.toLowerCase()), void(null != button && button.command());
                        this.editor.selection.save(), $blockEl.next("li").length > 0 && $("<" + $parent[0].tagName + "/>").append($blockEl.nextAll("li")).appendTo($blockEl), $blockEl.insertAfter($parentLi), $parent.children("li").length < 1 && $parent.remove(), this.editor.selection.restore()
                    } else if ($blockEl.is("p, h1, h2, h3, h4")) indentLevel = null != (ref = $blockEl.attr("data-indent")) ? ref : 0, indentLevel = 1 * indentLevel - 1, 0 > indentLevel && (indentLevel = 0), $blockEl.attr("data-indent", indentLevel);
                    else if ($blockEl.is("table") || $blockEl.is(".simditor-table")) {
                        if (range = this.editor.selection.getRange(), $td = $(range.commonAncestorContainer).closest("td, th"), $prevTd = $td.prev("td, th"), $prevTd.length > 0 || ($tr = $td.parent("tr"), $prevTr = $tr.prev("tr"), $prevTr.length < 1 && $tr.parent().is("tbody") && ($prevTr = $tr.parent("tbody").prev("thead").find("tr:first")), $prevTd = $prevTr.find("td:last, th:last")), !($td.length > 0 && $prevTd.length > 0)) return;
                        this.editor.selection.setRangeAtEndOf($prevTd)
                    }
                    return !0
                }
            }, Indentation.prototype.outdentText = function(range) {}, Indentation
        }(SimpleModule), Simditor = function(superClass) {
            function Simditor() {
                return Simditor.__super__.constructor.apply(this, arguments)
            }
            return extend(Simditor, superClass), Simditor.connect(Util), Simditor.connect(InputManager), Simditor.connect(UndoManager), Simditor.connect(Keystroke), Simditor.connect(Formatter), Simditor.connect(Selection), Simditor.connect(Toolbar), Simditor.connect(Indentation), Simditor.count = 0, Simditor.prototype.opts = {
                textarea: null,
                placeholder: "",
            ...
            }, Simditor.prototype._tpl = '<div class="simditor">\n  <div class="simditor-wrapper">\n    <div class="simditor-placeholder"></div>\n    <div class="simditor-body" contenteditable="true">\n    </div>\n  </div>\n</div>', Simditor.prototype._render = function() {
                ...
                if (this.el = $(this._tpl).insertBefore(this.textarea), this.wrapper = this.el.find(".simditor-wrapper"), this.body = this.wrapper.find(".simditor-body"), this.placeholderEl = this.wrapper.find(".simditor-placeholder").append(this.opts.placeholder), this.el.data("simditor", this), this.wrapper.append(this.textarea), this.textarea.data("simditor", this).blur(), this.body.attr("tabindex", this.textarea.attr("tabindex")), this.util.os.mac ? this.el.addClass("simditor-mac") : this.util.os.linux && this.el.addClass("simditor-linux"), this.util.os.mobile && this.el.addClass("simditor-mobile"), this.opts.params) {
                    ref = this.opts.params, results1 = [];
                    for (key in ref) val = ref[key], results1.push($("<input/>", {
                        type: "hidden",
                        name: key,
                        value: val
                ...
                var children, ref;
                return children = this.body.children(), 0 === children.length || 1 === children.length && this.util.isEmptyNode(children) && (null != (ref = children.data("indent")) ? ref : 0) < 1 ? this.placeholderEl.show() : this.placeholderEl.hide()
            }, Simditor.prototype.setValue = function(val) {
                return this.hidePopover(), this.textarea.val(val), this.body.html(val), this.formatter.format(), this.formatter.decorate(), this.util.reflow(this.body), this.inputManager.lastCaretPosition = null, this.trigger("valuechanged")
            }, Simditor.prototype.getValue = function() {
                return this.sync()
            }, Simditor.prototype.sync = function() {
                var children, cloneBody, emptyP, firstP, lastP, val;
                for (cloneBody = this.body.clone(), this.formatter.undecorate(cloneBody), this.formatter.format(cloneBody), this.formatter.autolink(cloneBody), children = cloneBody.children(), lastP = children.last("p"), firstP = children.first("p"); lastP.is("p") && this.util.isEmptyNode(lastP);) emptyP = lastP, lastP = lastP.prev("p"), emptyP.remove();
                for (; firstP.is("p") && this.util.isEmptyNode(firstP);) emptyP = firstP, firstP = lastP.next("p"), emptyP.remove();
                return cloneBody.find("img.uploading").remove(), val = $.trim(cloneBody.html()), this.textarea.val(val), val
            }, Simditor.prototype.focus = function() {
                var $blockEl, range;
                return this.body.is(":visible") && this.body.is("[contenteditable]") ? this.inputManager.lastCaretPosition ? this.undoManager.caretPosition(this.inputManager.lastCaretPosition) : ($blockEl = this.body.find("p").last(), $blockEl.length > 0 || ($blockEl = $("<p/>").append(this.util.phBr).appendTo(this.body)), range = document.createRange(), this.selection.setRangeAtEndOf($blockEl, range), this.body.focus()) : void this.el.find("textarea:visible").focus()
                ...
                return this.el.find(".simditor-popover").each(function(_this) {
                    return function(i, popover) {
                        return popover = $(popover).data("popover"), popover.active ? popover.hide() : void 0
                    }
                }(this))
            }, Simditor.prototype.destroy = function() {
                return this.triggerHandler("destroy"), this.textarea.closest("form").off(".simditor .simditor-" + this.id), this.selection.clear(), this.inputManager.focused = !1, this.textarea.insertBefore(this.el).hide().val("").removeData("simditor"), this.el.remove(), $(document).off(".simditor-" + this.id), $(window).off(".simditor-" + this.id), this.off()
            }, Simditor
        }(SimpleModule), Simditor.i18n = {
            "en-US": {
            ...
            function Button(opts) {
                this.editor = opts.editor, this.title = this._t(this.name), Button.__super__.constructor.call(this, opts)
            }
            return extend(Button, superClass), Button.prototype._tpl = {
                item: '<li><a tabindex="-1" unselectable="on" class="toolbar-item" href="javascript:;"><span></span></a></li>',
                menuWrapper: '<div class="toolbar-menu"></div>',
                menuItem: '<li><a tabindex="-1" unselectable="on" class="menu-item" href="javascript:;"><span></span></a></li>',
                separator: '<li><span class="separator"></span></li>'
            }, Button.prototype.name = "", Button.prototype.icon = "", Button.prototype.title = "", Button.prototype.text = "", Button.prototype.htmlTag = "", Button.prototype.disableTag = "", Button.prototype.menu = !1, Button.prototype.active = !1, Button.prototype.disabled = !1, Button.prototype.needFocus = !0, Button.prototype.shortcut = null, Button.prototype._init = function() {
                var j, len, ref, results1, tag;
                for (this.render(), this.el.on("mousedown", function(_this) {
                        return function(e) {
                            var exceed, param;
                            return e.preventDefault(), _this.el.hasClass("disabled") || _this.needFocus && !_this.editor.inputManager.focused ? !1 : _this.menu ? (_this.wrapper.toggleClass("menu-on").siblings("li").removeClass("menu-on"), _this.wrapper.is(".menu-on") && (exceed = _this.menuWrapper.offset().left + _this.menuWrapper.outerWidth() + 5 - _this.editor.wrapper.offset().left - _this.editor.wrapper.outerWidth(), exceed > 0 && _this.menuWrapper.css({
                                left: "auto",
                                right: 0
                            }), _this.trigger("menuexpand")), !1) : (param = _this.el.data("param"), _this.command(param), !1)
                        }
                    }(this)), this.wrapper.on("click", "a.menu-item", function(_this) {
                        return function(e) {
                            var btn, param;
                            return e.preventDefault(), btn = $(e.currentTarget), _this.wrapper.removeClass("menu-on"), btn.hasClass("disabled") || _this.needFocus && !_this.editor.inputManager.focused ? !1 : (_this.editor.toolbar.wrapper.removeClass("menu-on"), param = btn.data("param"), _this.command(param), !1)
                        }
                    }(this)), this.wrapper.on("mousedown", "a.menu-item", function(_this) {
                        return function(e) {
                            return !1
                        }
                    }(this)), this.editor.on("blur", function(_this) {
                        return function() {
                            return _this.editor.body.is(":visible") && _this.editor.body.is("[contenteditable]") ? (_this.setActive(!1), _this.setDisabled(!1)) : void 0
                        }
                    }(this)), null != this.shortcut && this.editor.inputManager.addShortcut(this.shortcut, function(_this) {
                        return function(e) {
                            return _this.el.mousedown(), !1
                        }
                    }(this)), ref = this.htmlTag.split(","), results1 = [], j = 0, len = ref.length; len > j; j++) tag = ref[j], tag = $.trim(tag), tag && $.inArray(tag, this.editor.formatter._allowedTags) < 0 ? results1.push(this.editor.formatter._allowedTags.push(tag)) : results1.push(void 0);
                return results1
                ...
                if ($.isArray(this.menu)) {
                    for (this.menuEl = $("<ul/>").appendTo(this.menuWrapper), ref = this.menu, results1 = [], j = 0, len = ref.length; len > j; j++) menuItem = ref[j], "|" !== menuItem ? ($menuItemEl = $(this._tpl.menuItem).appendTo(this.menuEl), $menuBtnEl = $menuItemEl.find("a.menu-item").attr({
                        title: null != (ref1 = menuItem.title) ? ref1 : menuItem.text,
                        "data-param": menuItem.param
                    }).addClass("menu-item-" + menuItem.name), menuItem.icon ? results1.push($menuBtnEl.find("span").addClass(this.iconClassOf(menuItem.icon))) : results1.push($menuBtnEl.find("span").text(menuItem.text))) : $(this._tpl.separator).appendTo(this.menuEl);
                    return results1
                }
            }, Button.prototype.setActive = function(active) {
                return active !== this.active ? (this.active = active, this.el.toggleClass("active", this.active), this.editor.toolbar.trigger("buttonstatus", [this])) : void 0
            }, Button.prototype.setDisabled = function(disabled) {
                return disabled !== this.disabled ? (this.disabled = disabled, this.el.toggleClass("disabled", this.disabled), this.editor.toolbar.trigger("buttonstatus", [this])) : void 0
            }, Button.prototype.status = function($node) {
                return null != $node && this.setDisabled($node.is(this.disableTag)), this.disabled ? !0 : (null != $node && this.setActive($node.is(this.htmlTag)), this.active)
            }, Button.prototype.command = function(param) {}, Button.prototype._t = function() {
                var args, ref, result;
                return args = 1 <= arguments.length ? slice.call(arguments, 0) : [], result = Button.__super__._t.apply(this, args), result || (result = (ref = this.editor)._t.apply(ref, args)), result
            }, Button
        }(SimpleModule), Simditor.Button = Button, Popover = function(superClass) {
            function Popover(opts) {
                this.button = opts.button, this.editor = opts.button.editor, Popover.__super__.constructor.call(this, opts)
            }
            return extend(Popover, superClass), Popover.prototype.offset = {
                top: 4,
                left: 0
            }, Popover.prototype.target = null, Popover.prototype.active = !1, Popover.prototype._init = function() {
                return this.el = $('<div class="simditor-popover"></div>').appendTo(this.editor.el).data("popover", this), this.render(), this.el.on("mouseenter", function(_this) {
                    return function(e) {
                        return _this.el.addClass("hover")
                    }
                }(this)), this.el.on("mouseleave", function(_this) {
                    return function(e) {
                        return _this.el.removeClass("hover")
                    }
                }(this))
            }, Popover.prototype.render = function() {}, Popover.prototype.show = function($target, position) {
                return null == position && (position = "bottom"), null != $target ? (this.el.siblings(".simditor-popover").each(function(_this) {
                    return function(i, popover) {
                        return popover = $(popover).data("popover"), popover.active ? popover.hide() : void 0
                    }
                }(this)), this.target = $target.addClass("selected"), this.active ? (this.refresh(position), this.trigger("popovershow")) : (this.active = !0, this.el.css({
                    left: -9999
                }).show(), setTimeout(function(_this) {
                    return function() {
                        return _this.refresh(position), _this.trigger("popovershow")
                    }
                }(this), 0))) : void 0
                ...
                var args, ref, result;
                return args = 1 <= arguments.length ? slice.call(arguments, 0) : [], result = Popover.__super__._t.apply(this, args), result || (result = (ref = this.button)._t.apply(ref, args)), result
            }, Popover
        }(SimpleModule), Simditor.Popover = Popover, TitleButton = function(superClass) {
            function TitleButton() {
                return TitleButton.__super__.constructor.apply(this, arguments)
            }
            return extend(TitleButton, superClass), TitleButton.prototype.name = "title", TitleButton.prototype.htmlTag = "h1, h2, h3, h4", TitleButton.prototype.disableTag = "pre, table", TitleButton.prototype._init = function() {
                return this.menu = [{
                    name: "normal",
                    ...
                    param: "h5"
                }], TitleButton.__super__._init.call(this)
            }, TitleButton.prototype.setActive = function(active, param) {
                return TitleButton.__super__.setActive.call(this, active), this.el.removeClass("active-p active-h1 active-h2 active-h3"), active ? this.el.addClass("active active-" + param) : void 0
            }, TitleButton.prototype.status = function($node) {
                var param, ref;
                return null != $node && this.setDisabled($node.is(this.disableTag)), this.disabled ? !0 : (null != $node && (param = null != (ref = $node[0].tagName) ? ref.toLowerCase() : void 0, this.setActive($node.is(this.htmlTag), param)), this.active)
            }, TitleButton.prototype.command = function(param) {
                var $contents, $endBlock, $startBlock, endNode, j, len, node, range, ref, results, startNode;
                for (range = this.editor.selection.getRange(), startNode = range.startContainer, endNode = range.endContainer, $startBlock = this.editor.util.closestBlockEl(startNode), $endBlock = this.editor.util.closestBlockEl(endNode), this.editor.selection.save(), range.setStartBefore($startBlock[0]), range.setEndAfter($endBlock[0]), $contents = $(range.extractContents()), results = [], $contents.children().each(function(_this) {
                        return function(i, el) {
                            var c, converted, j, len, results1;
                            for (converted = _this._convertEl(el, param), results1 = [], j = 0, len = converted.length; len > j; j++) c = converted[j], results1.push(results.push(c));
                            return results1
                        }
                    }(this)), ref = results.reverse(), j = 0, len = ref.length; len > j; j++) node = ref[j], range.insertNode(node[0]);
                ...
                return $el = $(el), results = [], $el.is(param) ? results.push($el) : ($block = $("<" + param + "/>").append($el.contents()), results.push($block)), results
            }, TitleButton
        }(Button), Simditor.Toolbar.addButton(TitleButton), BoldButton = function(superClass) {
            function BoldButton() {
                return BoldButton.__super__.constructor.apply(this, arguments)
            }
            return extend(BoldButton, superClass), BoldButton.prototype.name = "bold", BoldButton.prototype.icon = "bold", BoldButton.prototype.htmlTag = "b, strong", BoldButton.prototype.disableTag = "pre", BoldButton.prototype.shortcut = "cmd+b", BoldButton.prototype._init = function() {
                return this.editor.util.os.mac ? this.title = this.title + " ( Cmd + b )" : (this.title = this.title + " ( Ctrl + b )", this.shortcut = "ctrl+b"), BoldButton.__super__._init.call(this)
            }, BoldButton.prototype.status = function($node) {
                var active;
                return null != $node && this.setDisabled($node.is(this.disableTag)), this.disabled ? !0 : (active = document.queryCommandState("bold") === !0, this.setActive(active), active)
            }, BoldButton.prototype.command = function() {
                return document.execCommand("bold"), this.editor.util.support.oninput || this.editor.trigger("valuechanged"), $(document).trigger("selectionchange")
            }, BoldButton
        }(Button), Simditor.Toolbar.addButton(BoldButton), ItalicButton = function(superClass) {
            function ItalicButton() {
                return ItalicButton.__super__.constructor.apply(this, arguments)
            }
            return extend(ItalicButton, superClass), ItalicButton.prototype.name = "italic", ItalicButton.prototype.icon = "italic", ItalicButton.prototype.htmlTag = "i", ItalicButton.prototype.disableTag = "pre", ItalicButton.prototype.shortcut = "cmd+i", ItalicButton.prototype._init = function() {
                return this.editor.util.os.mac ? this.title = this.title + " ( Cmd + i )" : (this.title = this.title + " ( Ctrl + i )", this.shortcut = "ctrl+i"), ItalicButton.__super__._init.call(this)
            }, ItalicButton.prototype.status = function($node) {
                var active;
                return null != $node && this.setDisabled($node.is(this.disableTag)), this.disabled ? this.disabled : (active = document.queryCommandState("italic") === !0, this.setActive(active), active)
            }, ItalicButton.prototype.command = function() {
                return document.execCommand("italic"), this.editor.util.support.oninput || this.editor.trigger("valuechanged"), $(document).trigger("selectionchange")
            }, ItalicButton
        }(Button), Simditor.Toolbar.addButton(ItalicButton), UnderlineButton = function(superClass) {
            function UnderlineButton() {
                return UnderlineButton.__super__.constructor.apply(this, arguments)
            }
            return extend(UnderlineButton, superClass), UnderlineButton.prototype.name = "underline", UnderlineButton.prototype.icon = "underline", UnderlineButton.prototype.htmlTag = "u", UnderlineButton.prototype.disableTag = "pre", UnderlineButton.prototype.shortcut = "cmd+u", UnderlineButton.prototype.render = function() {
                return this.editor.util.os.mac ? this.title = this.title + " ( Cmd + u )" : (this.title = this.title + " ( Ctrl + u )", this.shortcut = "ctrl+u"), UnderlineButton.__super__.render.call(this)
            }, UnderlineButton.prototype.status = function($node) {
                var active;
                return null != $node && this.setDisabled($node.is(this.disableTag)), this.disabled ? this.disabled : (active = document.queryCommandState("underline") === !0, this.setActive(active), active)
            }, UnderlineButton.prototype.command = function() {
                return document.execCommand("underline"), this.editor.util.support.oninput || this.editor.trigger("valuechanged"), $(document).trigger("selectionchange")
            }, UnderlineButton
        }(Button), Simditor.Toolbar.addButton(UnderlineButton), ColorButton = function(superClass) {
            function ColorButton() {
                return ColorButton.__super__.constructor.apply(this, arguments)
            }
            return extend(ColorButton, superClass), ColorButton.prototype.name = "color", ColorButton.prototype.icon = "tint", ColorButton.prototype.disableTag = "pre", ColorButton.prototype.menu = !0, ColorButton.prototype.render = function() {
                var args;
                return args = 1 <= arguments.length ? slice.call(arguments, 0) : [], ColorButton.__super__.render.apply(this, args)
                ...
                return $('<ul class="color-list">\n  <li><a href="javascript:;" class="font-color font-color-1" data-color=""></a></li>\n  <li><a href="javascript:;" class="font-color font-color-2" data-color=""></a></li>\n  <li><a href="javascript:;" class="font-color font-color-3" data-color=""></a></li>\n  <li><a href="javascript:;" class="font-color font-color-4" data-color=""></a></li>\n  <li><a href="javascript:;" class="font-color font-color-5" data-color=""></a></li>\n  <li><a href="javascript:;" class="font-color font-color-6" data-color=""></a></li>\n  <li><a href="javascript:;" class="font-color font-color-7" data-color=""></a></li>\n  <li><a href="javascript:;" class="font-color font-color-default" data-color=""></a></li>\n</ul>').appendTo(this.menuWrapper), this.menuWrapper.on("mousedown", ".color-list", function(e) {
                    ...
                    return function(e) {
                        var $link, $p, hex, rgb;
                        if (_this.wrapper.removeClass("menu-on"), $link = $(e.currentTarget), $link.hasClass("font-color-default")) {
                            if ($p = _this.editor.body.find("p, li"), !($p.length > 0)) return;
                            rgb = window.getComputedStyle($p[0], null).getPropertyValue("color"), hex = _this._convertRgbToHex(rgb)
                        } else rgb = window.getComputedStyle($link[0], null).getPropertyValue("background-color"), hex = _this._convertRgbToHex(rgb);
                        return hex ? (document.execCommand("foreColor", !1, hex), _this.editor.util.support.oninput ? void 0 : _this.editor.trigger("valuechanged")) : void 0
                    }
                }(this))
            }, ColorButton.prototype._convertRgbToHex = function(rgb) {
                var match, re, rgbToHex;
                return re = /rgb\((\d+),\s?(\d+),\s?(\d+)\)/g, (match = re.exec(rgb)) ? (rgbToHex = function(r, g, b) {
                    var componentToHex;
                    return componentToHex = function(c) {
                        var hex;
                        return hex = c.toString(16), 1 === hex.length ? "0" + hex : hex
                    }, "#" + componentToHex(r) + componentToHex(g) + componentToHex(b)
                })(1 * match[1], 1 * match[2], 1 * match[3]) : ""
            }, ColorButton
        }(Button), Simditor.Toolbar.addButton(ColorButton), ListButton = function(superClass) {
            function ListButton() {
                return ListButton.__super__.constructor.apply(this, arguments)
            }
            return extend(ListButton, superClass), ListButton.prototype.type = "", ListButton.prototype.disableTag = "pre, table", ListButton.prototype.status = function($node) {
                var anotherType;
                return null != $node && this.setDisabled($node.is(this.disableTag)), this.disabled ? !0 : null == $node ? this.active : (anotherType = "ul" === this.type ? "ol" : "ul", $node.is(anotherType) ? (this.setActive(!1), !0) : (this.setActive($node.is(this.htmlTag)), this.active))
                ...
                for (range = this.editor.selection.getRange(), startNode = range.startContainer, endNode = range.endContainer, $startBlock = this.editor.util.closestBlockEl(startNode), $endBlock = this.editor.util.closestBlockEl(endNode), this.editor.selection.save(), range.setStartBefore($startBlock[0]), range.setEndAfter($endBlock[0]), $startBlock.is("li") && $endBlock.is("li") && ($furthestStart = this.editor.util.furthestNode($startBlock, "ul, ol"), $furthestEnd = this.editor.util.furthestNode($endBlock, "ul, ol"), $furthestStart.is($furthestEnd) ? (getListLevel = function($li) {
                        var lvl;
                        for (lvl = 1; !$li.parent().is($furthestStart);) lvl += 1, $li = $li.parent();
                        return lvl
                    }, startLevel = getListLevel($startBlock), endLevel = getListLevel($endBlock), $parent = startLevel > endLevel ? $endBlock.parent() : $startBlock.parent(), range.setStartBefore($parent[0]), range.setEndAfter($parent[0])) : (range.setStartBefore($furthestStart[0]), range.setEndAfter($furthestEnd[0]))), $contents = $(range.extractContents()), results = [], $contents.children().each(function(_this) {
                        return function(i, el) {
                            var c, converted, j, len, results1;
                            for (converted = _this._convertEl(el), results1 = [], j = 0, len = converted.length; len > j; j++) c = converted[j], results.length && results[results.length - 1].is(_this.type) && c.is(_this.type) ? results1.push(results[results.length - 1].append(c.children())) : results1.push(results.push(c));
                            return results1
                        }
                    }(this)), ref = results.reverse(), j = 0, len = ref.length; len > j; j++) node = ref[j], range.insertNode(node[0]);
                return this.editor.selection.restore(), this.editor.trigger("valuechanged")
                ...
                if ($el = $(el), results = [], anotherType = "ul" === this.type ? "ol" : "ul",
                    $el.is(this.type)) $el.children("li").each(function(_this) {
                    return function(i, li) {
                        var $childList, $li, block;
                        return $li = $(li), $childList = $li.children("ul, ol").remove(), block = $("<p/>").append($(li).html() || _this.editor.util.phBr), results.push(block), $childList.length > 0 ? results.push($childList) : void 0
                    }
                }(this));
                else if ($el.is(anotherType)) block = $("<" + this.type + "/>").append($el.html()), results.push(block);
                else if ($el.is("blockquote")) {
                    for (ref = $el.children().get(), j = 0, len = ref.length; len > j; j++) child = ref[j], children = this._convertEl(child);
                    $.merge(results, children)
                } else $el.is("table") || (block = $("<" + this.type + "><li></li></" + this.type + ">"), block.find("li").append($el.html() || this.editor.util.phBr), results.push(block));
                return results
            }, ListButton
        }(Button), OrderListButton = function(superClass) {
            function OrderListButton() {
                return OrderListButton.__super__.constructor.apply(this, arguments)
            }
            return extend(OrderListButton, superClass), OrderListButton.prototype.type = "ol", OrderListButton.prototype.name = "ol", OrderListButton.prototype.icon = "list-ol", OrderListButton.prototype.htmlTag = "ol", OrderListButton.prototype.shortcut = "cmd+/", OrderListButton.prototype._init = function() {
                return this.editor.util.os.mac ? this.title = this.title + " ( Cmd + / )" : (this.title = this.title + " ( ctrl + / )", this.shortcut = "ctrl+/"), OrderListButton.__super__._init.call(this)
            }, OrderListButton
        }(ListButton), UnorderListButton = function(superClass) {
            function UnorderListButton() {
                return UnorderListButton.__super__.constructor.apply(this, arguments)
            }
            return extend(UnorderListButton, superClass), UnorderListButton.prototype.type = "ul", UnorderListButton.prototype.name = "ul", UnorderListButton.prototype.icon = "list-ul", UnorderListButton.prototype.htmlTag = "ul", UnorderListButton.prototype.shortcut = "cmd+.", UnorderListButton.prototype._init = function() {
                return this.editor.util.os.mac ? this.title = this.title + " ( Cmd + . )" : (this.title = this.title + " ( Ctrl + . )", this.shortcut = "ctrl+."), UnorderListButton.__super__._init.call(this)
            }, UnorderListButton
        }(ListButton), Simditor.Toolbar.addButton(OrderListButton), Simditor.Toolbar.addButton(UnorderListButton), BlockquoteButton = function(superClass) {
            function BlockquoteButton() {
                return BlockquoteButton.__super__.constructor.apply(this, arguments)
            }
            return extend(BlockquoteButton, superClass), BlockquoteButton.prototype.name = "blockquote", BlockquoteButton.prototype.icon = "quote-left", BlockquoteButton.prototype.htmlTag = "blockquote", BlockquoteButton.prototype.disableTag = "pre, table", BlockquoteButton.prototype.command = function() {
                var $contents, $endBlock, $startBlock, endNode, j, len, node, range, ref, results, startNode;
                for (range = this.editor.selection.getRange(), startNode = range.startContainer, endNode = range.endContainer, $startBlock = this.editor.util.furthestBlockEl(startNode), $endBlock = this.editor.util.furthestBlockEl(endNode), this.editor.selection.save(), range.setStartBefore($startBlock[0]), range.setEndAfter($endBlock[0]), $contents = $(range.extractContents()), results = [], $contents.children().each(function(_this) {
                        return function(i, el) {
                            var c, converted, j, len, results1;
                            for (converted = _this._convertEl(el), results1 = [], j = 0, len = converted.length; len > j; j++) c = converted[j], results.length && results[results.length - 1].is(_this.htmlTag) && c.is(_this.htmlTag) ? results1.push(results[results.length - 1].append(c.children())) : results1.push(results.push(c));
                            return results1
                        }
                    }(this)), ref = results.reverse(), j = 0, len = ref.length; len > j; j++) node = ref[j], range.insertNode(node[0]);
                return this.editor.selection.restore(), this.editor.trigger("valuechanged")
                ...
                return $el = $(el), results = [], $el.is(this.htmlTag) ? $el.children().each(function(_this) {
                    return function(i, node) {
                        return results.push($(node))
                    }
                }(this)) : (block = $("<" + this.htmlTag + "/>").append($el), results.push(block)), results
            }, BlockquoteButton
        }(Button), Simditor.Toolbar.addButton(BlockquoteButton), CodeButton = function(superClass) {
            function CodeButton() {
                return CodeButton.__super__.constructor.apply(this, arguments)
            }
            return extend(CodeButton, superClass), CodeButton.prototype.name = "code", CodeButton.prototype.icon = "code", CodeButton.prototype.htmlTag = "pre", CodeButton.prototype.disableTag = "li, table", CodeButton.prototype._init = function() {
                return CodeButton.__super__._init.call(this), this.editor.on("decorate", function(_this) {
                    return function(e, $el) {
                        return $el.find("pre").each(function(i, pre) {
                            return _this.decorate($(pre))
                        })
                    }
                }(this)), this.editor.on("undecorate", function(_this) {
                    return function(e, $el) {
                        return $el.find("pre").each(function(i, pre) {
                ...
                var args;
                return args = 1 <= arguments.length ? slice.call(arguments, 0) : [], CodeButton.__super__.render.apply(this, args), this.popover = new CodePopover({
                    button: this
                })
            }, CodeButton.prototype.status = function($node) {
                var result;
                return result = CodeButton.__super__.status.call(this, $node), this.active ? this.popover.show($node) : this.editor.util.isBlockNode($node) && this.popover.hide(), result
            }, CodeButton.prototype.decorate = function($pre) {
                var $code, lang, ref;
                return $code = $pre.find("> code"), $code.length > 0 && (lang = null != (ref = $code.attr("class").match(/lang-(\S+)/)) ? ref[1] : void 0, $code.contents().unwrap(), lang) ? $pre.attr("data-lang", lang) : void 0
            }, CodeButton.prototype.undecorate = function($pre) {
                var $code, lang;
                return lang = $pre.attr("data-lang"), $code = $("<code/>"), lang && -1 !== lang && $code.addClass("lang-" + lang), $pre.wrapInner($code).removeAttr("data-lang")
            }, CodeButton.prototype.command = function() {
                var $contents, $endBlock, $startBlock, endNode, j, len, node, range, ref, results, startNode;
                for (range = this.editor.selection.getRange(), startNode = range.startContainer, endNode = range.endContainer, $startBlock = this.editor.util.closestBlockEl(startNode), $endBlock = this.editor.util.closestBlockEl(endNode), range.setStartBefore($startBlock[0]), range.setEndAfter($endBlock[0]), $contents = $(range.extractContents()), results = [], $contents.children().each(function(_this) {
                        return function(i, el) {
                            var c, converted, j, len, results1;
                            for (converted = _this._convertEl(el), results1 = [], j = 0, len = converted.length; len > j; j++) c = converted[j], results.length && results[results.length - 1].is(_this.htmlTag) && c.is(_this.htmlTag) ? results1.push(results[results.length - 1].append(c.contents())) : results1.push(results.push(c));
                            return results1
                        }
                    }(this)), ref = results.reverse(), j = 0, len = ref.length; len > j; j++) node = ref[j], range.insertNode(node[0]);
                return this.editor.selection.setRangeAtEndOf(results[0]), this.editor.trigger("valuechanged")
            }, CodeButton.prototype._convertEl = function(el) {
                var $el, block, codeStr, results;
                return $el = $(el), results = [], $el.is(this.htmlTag) ? (block = $("<p/>").append($el.html().replace("\n", "<br/>")), results.push(block)) : (codeStr = !$el.text() && 1 === $el.children().length && $el.children().is("br") ? "\n" : this.editor.formatter.clearHtml($el), block = $("<" + this.htmlTag + "/>").text(codeStr), results.push(block)), results
            }, CodeButton
        }(Button), CodePopover = function(superClass) {
            function CodePopover() {
                return CodePopover.__super__.constructor.apply(this, arguments)
            }
            return extend(CodePopover, superClass), CodePopover.prototype.render = function() {
                return this._tpl = '<div class="code-settings">\n  <div class="settings-field">\n    <select class="select-lang">\n      <option value="-1">' + this._t("selectLanguage") + '</option>\n      <option value="bash">Bash</option>\n      <option value="c++">C++</option>\n      <option value="cs">C#</option>\n      <option value="css">CSS</option>\n      <option value="erlang">Erlang</option>\n      <option value="less">Less</option>\n      <option value="scss">Sass</option>\n      <option value="diff">Diff</option>\n      <option value="coffeeScript">CoffeeScript</option>\n      <option value="html">Html,XML</option>\n      <option value="json">JSON</option>\n      <option value="java">Java</option>\n      <option value="js">JavaScript</option>\n      <option value="markdown">Markdown</option>\n      <option value="oc">Objective C</option>\n      <option value="php">PHP</option>\n      <option value="perl">Perl</option>\n      <option value="python">Python</option>\n      <option value="ruby">Ruby</option>\n      <option value="sql">SQL</option>\n    </select>\n  </div>\n</div>', this.el.addClass("code-popover").append(this._tpl), this.selectEl = this.el.find(".select-lang"), this.selectEl.on("change", function(_this) {
                    return function(e) {
                        var selected;
                        return _this.lang = _this.selectEl.val(), selected = _this.target.hasClass("selected"), _this.target.removeClass().removeAttr("data-lang"), -1 !== _this.lang && _this.target.attr("data-lang", _this.lang), selected ? _this.target.addClass("selected") : void 0
                    }
                }(this)), this.editor.on("valuechanged", function(_this) {
                    return function(e) {
                        return _this.active ? _this.refresh() : void 0
                    }
                }(this))
            }, CodePopover.prototype.show = function() {
                var args;
                return args = 1 <= arguments.length ? slice.call(arguments, 0) : [], CodePopover.__super__.show.apply(this, args), this.lang = this.target.attr("data-lang"), null != this.lang ? this.selectEl.val(this.lang) : this.selectEl.val(-1)
            }, CodePopover
        }(Popover), Simditor.Toolbar.addButton(CodeButton), LinkButton = function(superClass) {
            function LinkButton() {
                return LinkButton.__super__.constructor.apply(this, arguments)
            }
            return extend(LinkButton, superClass), LinkButton.prototype.name = "link", LinkButton.prototype.icon = "link", LinkButton.prototype.htmlTag = "a", LinkButton.prototype.disableTag = "pre", LinkButton.prototype.render = function() {
                var args;
                return args = 1 <= arguments.length ? slice.call(arguments, 0) : [], LinkButton.__super__.render.apply(this, args), this.popover = new LinkPopover({
                    button: this
                })
            }, LinkButton.prototype.status = function($node) {
                var showPopover;
                return null != $node && this.setDisabled($node.is(this.disableTag)), this.disabled ? !0 : null == $node ? this.active : (showPopover = !0, !$node.is(this.htmlTag) || $node.is('[class^="simditor-"]') ? (this.setActive(!1), showPopover = !1) : this.editor.selection.rangeAtEndOf($node) ? (this.setActive(!0), showPopover = !1) : this.setActive(!0), showPopover ? this.popover.show($node) : this.editor.util.isBlockNode($node) && this.popover.hide(), this.active)
            }, LinkButton.prototype.command = function() {
                var $contents, $endBlock, $link, $newBlock, $startBlock, endNode, linkText, range, startNode, txtNode;
                return range = this.editor.selection.getRange(), this.active ? ($link = $(range.commonAncestorContainer).closest("a"), txtNode = document.createTextNode($link.text()), $link.replaceWith(txtNode), range.selectNode(txtNode)) : (startNode = range.startContainer, endNode = range.endContainer, $startBlock = this.editor.util.closestBlockEl(startNode), $endBlock = this.editor.util.closestBlockEl(endNode), $contents = $(range.extractContents()), linkText = this.editor.formatter.clearHtml($contents.contents(), !1), $link = $("<a/>", {
                    href: "http://www.example.com",
                    target: "_blank",
                    text: linkText || this._t("linkText")
                }), $startBlock[0] === $endBlock[0] ? range.insertNode($link[0]) : ($newBlock = $("<p/>").append($link), range.insertNode($newBlock[0])), range.selectNodeContents($link[0]), this.popover.one("popovershow", function(_this) {
                    return function() {
                        return linkText ? (_this.popover.urlEl.focus(), _this.popover.urlEl[0].select()) : (_this.popover.textEl.focus(), _this.popover.textEl[0].select())
                    }
                }(this))), this.editor.selection.selectRange(range), this.editor.trigger("valuechanged")
            }, LinkButton
        }(Button), LinkPopover = function(superClass) {
            function LinkPopover() {
                return LinkPopover.__super__.constructor.apply(this, arguments)
            }
            return extend(LinkPopover, superClass), LinkPopover.prototype.render = function() {
                var tpl;
                return tpl = '<div class="link-settings">\n  <div class="settings-field">\n    <label>' + this._t("text") + '</label>\n    <input class="link-text" type="text"/>\n    <a class="btn-unlink" href="javascript:;" title="' + this._t("removeLink") + '" tabindex="-1"><span class="simditor-icon simditor-icon-unlink"></span></a>\n  </div>\n  <div class="settings-field">\n    <label>' + this._t("linkUrl") + '</label>\n    <input class="link-url" type="text"/>\n  </div>\n</div>', this.el.addClass("link-popover").append(tpl), this.textEl = this.el.find(".link-text"), this.urlEl = this.el.find(".link-url"), this.unlinkEl = this.el.find(".btn-unlink"), this.textEl.on("keyup", function(_this) {
                    return function(e) {
                        return 13 !== e.which ? _this.target.text(_this.textEl.val()) : void 0
                    }
                }(this)), this.urlEl.on("keyup", function(_this) {
                    return function(e) {
                        var val;
                        if (13 !== e.which) return val = _this.urlEl.val(), !/https?:\/\/|^\//gi.test(val) && val && (val = "http://" + val), _this.target.attr("href", val)
                    }
                }(this)), $([this.urlEl[0], this.textEl[0]]).on("keydown", function(_this) {
                    return function(e) {
                        return 13 === e.which || 27 === e.which || !e.shiftKey && 9 === e.which && $(e.target).hasClass("link-url") ? (e.preventDefault(), setTimeout(function() {
                            var range;
                            return range = document.createRange(), _this.editor.selection.setRangeAfter(_this.target, range), _this.hide(), _this.editor.trigger("valuechanged")
                        }, 0)) : void 0
                    }
                }(this)), this.unlinkEl.on("click", function(_this) {
                    return function(e) {
                        var range, txtNode;
                        return txtNode = document.createTextNode(_this.target.text()), _this.target.replaceWith(txtNode), _this.hide(), range = document.createRange(), _this.editor.selection.setRangeAfter(txtNode, range), _this.editor.trigger("valuechanged")
                    }
                }(this))
            }, LinkPopover.prototype.show = function() {
                var args;
                return args = 1 <= arguments.length ? slice.call(arguments, 0) : [], LinkPopover.__super__.show.apply(this, args), this.textEl.val(this.target.text()), this.urlEl.val(this.target.attr("href"))
            }, LinkPopover
        }(Popover), Simditor.Toolbar.addButton(LinkButton), ImageButton = function(superClass) {
            function ImageButton() {
                return ImageButton.__super__.constructor.apply(this, arguments)
            }
            return extend(ImageButton, superClass), ImageButton.prototype.name = "image", ImageButton.prototype.icon = "picture-o", ImageButton.prototype.htmlTag = "img", ImageButton.prototype.disableTag = "pre, table", ImageButton.prototype.defaultImage = "", ImageButton.prototype.needFocus = !1, ImageButton.prototype._init = function() {
                var item, j, len, ref;
                if (this.editor.opts.imageButton)
                    if (Array.isArray(this.editor.opts.imageButton))
                        for (this.menu = [], ref = this.editor.opts.imageButton, j = 0, len = ref.length; len > j; j++) item = ref[j], this.menu.push({
                            name: item + "-image",
                ...
                return this.defaultImage = this.editor.opts.defaultImage, this.editor.body.on("click", "img:not([data-non-image])", function(_this) {
                    return function(e) {
                        var $img, range;
                        return $img = $(e.currentTarget), range = document.createRange(), range.selectNode($img[0]), _this.editor.selection.selectRange(range), _this.editor.util.support.onselectionchange || _this.editor.trigger("selectionchanged"), !1
                    }
                }(this)), this.editor.body.on("mouseup", "img:not([data-non-image])", function(_this) {
                    return function(e) {
                        return !1
                    }
                }(this)), this.editor.on("selectionchanged.image", function(_this) {
                    return function() {
                        var $contents, $img, range;
                        return range = _this.editor.selection.getRange(), null != range ? ($contents = $(range.cloneContents()).contents(), 1 === $contents.length && $contents.is("img:not([data-non-image])") ? ($img = $(range.startContainer).contents().eq(range.startOffset), _this.popover.show($img)) : _this.popover.hide()) : void 0
                    }
                }(this)), this.editor.on("valuechanged.image", function(_this) {
                    return function() {
                        var $masks;
                        return $masks = _this.editor.wrapper.find(".simditor-image-loading"), $masks.length > 0 ? $masks.each(function(i, mask) {
                            var $img, $mask, file;
                            return $mask = $(mask), $img = $mask.data("img"), !($img && $img.parent().length > 0) && ($mask.remove(), $img && (file = $img.data("file"), file && (_this.editor.uploader.cancel(file), _this.editor.body.find("img.uploading").length < 1))) ? _this.editor.uploader.trigger("uploadready", [file]) : void 0
                        }) : void 0
                    }
                }(this)), ImageButton.__super__._init.call(this)
            }, ImageButton.prototype.render = function() {
                var args;
                return args = 1 <= arguments.length ? slice.call(arguments, 0) : [], ImageButton.__super__.render.apply(this, args), this.popover = new ImagePopover({
                    button: this
                }), "upload" === this.editor.opts.imageButton ? this._initUploader(this.el) : void 0
            }, ImageButton.prototype.renderMenu = function() {
                return ImageButton.__super__.renderMenu.call(this), this._initUploader()
            }, ImageButton.prototype._initUploader = function($uploadItem) {
                var $input, createInput;
                return null == $uploadItem && ($uploadItem = this.menuEl.find(".menu-item-upload-image")), null == this.editor.uploader ? void this.el.find(".btn-upload").remove() : ($input = null, createInput = function(_this) {
                    return function() {
                        return $input && $input.remove(), $input = $('<input type="file" title="' + _this._t("uploadImage") + '" accept="image/*">').appendTo($uploadItem)
                    }
                }(this), createInput(), $uploadItem.on("click mousedown", "input[type=file]", function(_this) {
                    return function(e) {
                        return e.stopPropagation()
                    }
                }(this)), $uploadItem.on("change", "input[type=file]", function(_this) {
                    return function(e) {
                        return _this.editor.inputManager.focused ? (_this.editor.uploader.upload($input, {
                            inline: !0
                        }), createInput()) : (_this.editor.one("focus", function(e) {
                            return _this.editor.uploader.upload($input, {
                                inline: !0
                            }), createInput()
                        }), _this.editor.focus()), _this.wrapper.removeClass("menu-on")
                    }
                }(this)), this.editor.uploader.on("beforeupload", function(_this) {
                    return function(e, file) {
                        var $img;
                        if (file.inline) return file.img ? $img = $(file.img) : ($img = _this.createImage(file.name), file.img = $img), $img.addClass("uploading"), $img.data("file", file), _this.editor.uploader.readImageFile(file.obj, function(img) {
                            var src;
                            if ($img.hasClass("uploading")) return src = img ? img.src : _this.defaultImage, _this.loadImage($img, src, function() {
                                return _this.popover.active ? (_this.popover.refresh(), _this.popover.srcEl.val(_this._t("uploading")).prop("disabled", !0)) : void 0
                            })
                        })
                    }
                }(this)), this.editor.uploader.on("uploadprogress", $.proxy(this.editor.util.throttle(function(e, file, loaded, total) {
                    var $img, $mask, percent;
                    if (file.inline && ($mask = file.img.data("mask"))) return $img = $mask.data("img"), $img.hasClass("uploading") && $img.parent().length > 0 ? (percent = loaded / total, percent = (100 * percent).toFixed(0), percent > 99 && (percent = 99), $mask.find(".progress").height(100 - percent + "%")) : void $mask.remove()
                }, 500), this)), this.editor.uploader.on("uploadsuccess", function(_this) {
                    return function(e, file, result) {
                        var $img, $mask, msg;
                        if (file.inline && ($img = file.img, $img.hasClass("uploading") && $img.parent().length > 0)) {
                            if ($img.removeData("file"), $img.removeClass("uploading").removeClass("loading"), $mask = $img.data("mask"), $mask && $mask.remove(), $img.removeData("mask"), "object" != typeof result) try {
                            ...
                            return result.success === !1 ? (msg = result.msg || _this._t("uploadFailed"), alert(msg), $img.attr("src", _this.defaultImage)) : $img.attr("src", result.file_path), _this.popover.active && (_this.popover.srcEl.prop("disabled", !1), _this.popover.srcEl.val(result.file_path)), _this.editor.trigger("valuechanged"), _this.editor.body.find("img.uploading").length < 1 ? _this.editor.uploader.trigger("uploadready", [file, result]) : void 0
                        }
                    }
                }(this)), this.editor.uploader.on("uploaderror", function(_this) {
                    return function(e, file, xhr) {
                        var $img, $mask, msg, result;
                        if (file.inline && "abort" !== xhr.statusText) {
                            if (xhr.responseText) {
                                try {
                                    result = $.parseJSON(xhr.responseText), msg = result.msg
                                } catch (_error) {
                                    e = _error, msg = _this._t("uploadError")
                                }
                                alert(msg)
                            }
                            if ($img = file.img, $img.hasClass("uploading") && $img.parent().length > 0) return $img.removeData("file"), $img.removeClass("uploading").removeClass("loading"), $mask = $img.data("mask"), $mask && $mask.remove(), $img.removeData("mask"), $img.attr("src", _this.defaultImage), _this.popover.active && (_this.popover.srcEl.prop("disabled", !1), _this.popover.srcEl.val(_this.defaultImage)), _this.editor.trigger("valuechanged"), _this.editor.body.find("img.uploading").length < 1 ? _this.editor.uploader.trigger("uploadready", [file, result]) : void 0
                        }
                    }
                }(this)))
            }, ImageButton.prototype.status = function($node) {
                return null != $node && this.setDisabled($node.is(this.disableTag)), this.disabled ? !0 : void 0
            }, ImageButton.prototype.loadImage = function($img, src, callback) {
                var $mask, img, positionMask;
                return positionMask = function(_this) {
                    return function() {
                        var imgOffset, wrapperOffset;
                        return imgOffset = $img.offset(), wrapperOffset = _this.editor.wrapper.offset(), $mask.css({
                ...
                }(this), $img.addClass("loading"), $mask = $img.data("mask"), $mask || ($mask = $('<div class="simditor-image-loading"><div class="progress"></div></div>').hide().appendTo(this.editor.wrapper), positionMask(), $img.data("mask", $mask), $mask.data("img", $img)), img = new Image, img.onload = function(_this) {
                    return function() {
                        var height, width;
                        if ($img.hasClass("loading") || $img.hasClass("uploading")) return width = img.width, height = img.height, $img.attr({
                            src: src,
                            "data-image-size": width + "," + height
                        }).removeClass("loading"), $img.hasClass("uploading") ? (_this.editor.util.reflow(_this.editor.body), positionMask()) : ($mask.remove(), $img.removeData("mask")), callback(img)
                    }
                }(this), img.onerror = function(_this) {
                    return function() {
                        return callback(!1), $mask.remove(), $img.removeData("mask").removeClass("loading")
                    }
                }(this), img.src = src
            }, ImageButton.prototype.createImage = function(name) {
                var $block, $img, $nextBlock, range;
                return null == name && (name = "Image"), this.editor.inputManager.focused || this.editor.focus(), range = this.editor.selection.getRange(), range.deleteContents(), $block = this.editor.util.closestBlockEl(), $block.is("p") && !this.editor.util.isEmptyNode($block) && ($block = $("<p/>").append(this.editor.util.phBr).insertAfter($block), this.editor.selection.setRangeAtStartOf($block, range)), $img = $("<img/>").attr("alt", name), range.insertNode($img[0]), $nextBlock = $block.next("p"), $nextBlock.length > 0 || ($nextBlock = $("<p/>").append(this.editor.util.phBr).insertAfter($block)), this.editor.selection.setRangeAtStartOf($nextBlock), $img
            }, ImageButton.prototype.command = function(src) {
                var $img;
                return $img = this.createImage(), this.loadImage($img, src || this.defaultImage, function(_this) {
                    return function() {
                        return _this.editor.trigger("valuechanged"), _this.editor.util.reflow($img), $img.click(), _this.popover.one("popovershow", function() {
                            return _this.popover.srcEl.focus(), _this.popover.srcEl[0].select()
                        })
                    }
                }(this))
            }, ImageButton
        }(Button), ImagePopover = function(superClass) {
            function ImagePopover() {
                return ImagePopover.__super__.constructor.apply(this, arguments)
            }
            return extend(ImagePopover, superClass), ImagePopover.prototype.offset = {
                top: 6,
                left: -4
            }, ImagePopover.prototype.render = function() {
                var tpl;
                return tpl = '<div class="link-settings">\n  <div class="settings-field">\n    <label>' + this._t("imageUrl") + '</label>\n    <input class="image-src" type="text" tabindex="1" />\n    <a class="btn-upload" href="javascript:;" title="' + this._t("uploadImage") + '" tabindex="-1">\n      <span class="simditor-icon simditor-icon-upload"></span>\n    </a>\n  </div>\n  <div class=\'settings-field\'>\n    <label>' + this._t("imageAlt") + '</label>\n    <input class="image-alt" id="image-alt" type="text" tabindex="1" />\n  </div>\n  <div class="settings-field">\n    <label>' + this._t("imageSize") + '</label>\n    <input class="image-size" id="image-width" type="text" tabindex="2" />\n    <span class="times">×</span>\n    <input class="image-size" id="image-height" type="text" tabindex="3" />\n    <a class="btn-restore" href="javascript:;" title="' + this._t("restoreImageSize") + '" tabindex="-1">\n      <span class="simditor-icon simditor-icon-undo"></span>\n    </a>\n  </div>\n</div>', this.el.addClass("image-popover").append(tpl), this.srcEl = this.el.find(".image-src"), this.widthEl = this.el.find("#image-width"), this.heightEl = this.el.find("#image-height"), this.altEl = this.el.find("#image-alt"), this.srcEl.on("keydown", function(_this) {
                    return function(e) {
                        return 13 !== e.which || _this.target.hasClass("uploading") ? void 0 : (e.preventDefault(), _this.button.editor.body.focus(), _this.button.editor.selection.setRangeAfter(_this.target), _this.hide())
                    }
                }(this)), this.srcEl.on("blur", function(_this) {
                    return function(e) {
                        return _this._loadImage(_this.srcEl.val())
                    }
                }(this)), this.el.find(".image-size").on("blur", function(_this) {
                    return function(e) {
                        return _this._resizeImg($(e.currentTarget)), _this.el.data("popover").refresh()
                    }
                }(this)), this.el.find(".image-size").on("keyup", function(_this) {
                    return function(e) {
                        var inputEl;
                        return inputEl = $(e.currentTarget), 13 !== e.which && 27 !== e.which && 9 !== e.which ? _this._resizeImg(inputEl, !0) : void 0
                    }
                }(this)), this.el.find(".image-size").on("keydown", function(_this) {
                    return function(e) {
                        var inputEl;
                        return inputEl = $(e.currentTarget), 13 === e.which || 27 === e.which ? (e.preventDefault(), 13 === e.which ? _this._resizeImg(inputEl) : _this._restoreImg(), _this.button.editor.body.focus(), _this.button.editor.selection.setRangeAfter(_this.target), _this.hide()) : 9 === e.which ? _this.el.data("popover").refresh() : void 0
                    }
                }(this)), this.altEl.on("keydown", function(_this) {
                    return function(e) {
                        return 13 === e.which ? (e.preventDefault(), _this.button.editor.body.focus(), _this.button.editor.selection.setRangeAfter(_this.target), _this.hide()) : void 0
                    }
                }(this)), this.altEl.on("keyup", function(_this) {
                    return function(e) {
                        return 13 !== e.which && 27 !== e.which && 9 !== e.which ? (_this.alt = _this.altEl.val(), _this.target.attr("alt", _this.alt)) : void 0
                    }
                }(this)), this.el.find(".btn-restore").on("click", function(_this) {
                    return function(e) {
                        return _this._restoreImg(), _this.el.data("popover").refresh()
                    }
                }(this)), this.editor.on("valuechanged", function(_this) {
                    return function(e) {
                        return _this.active ? _this.refresh() : void 0
                ...
                return $uploadBtn = this.el.find(".btn-upload"), null == this.editor.uploader ? void $uploadBtn.remove() : (createInput = function(_this) {
                    return function() {
                        return _this.input && _this.input.remove(), _this.input = $('<input type="file" title="' + _this._t("uploadImage") + '" accept="image/*">').appendTo($uploadBtn)
                    }
                }(this), createInput(), this.el.on("click mousedown", "input[type=file]", function(_this) {
                    return function(e) {
                        return e.stopPropagation()
                    }
                }(this)), this.el.on("change", "input[type=file]", function(_this) {
                    return function(e) {
                        return _this.editor.uploader.upload(_this.input, {
                            inline: !0,
                            img: _this.target
                        }), createInput()
                    }
                ...
                return null == onlySetVal && (onlySetVal = !1), value = 1 * inputEl.val(), $.isNumeric(value) || 0 > value ? (inputEl.is(this.widthEl) ? (height = this.height * value / this.width, this.heightEl.val(height)) : (width = this.width * value / this.height, this.widthEl.val(width)), onlySetVal || this.target.attr({
                    width: width || value,
                    height: height || value
                }), this.editor.trigger("valuechanged")) : void 0
            }, ImagePopover.prototype._restoreImg = function() {
                var ref, size;
                return size = (null != (ref = this.target.data("image-size")) ? ref.split(",") : void 0) || [this.width, this.height], this.target.attr({
                    width: 1 * size[0],
                    height: 1 * size[1]
                }), this.widthEl.val(size[0]), this.heightEl.val(size[1]), this.editor.trigger("valuechanged")
            }, ImagePopover.prototype._loadImage = function(src, callback) {
                return /^data:image/.test(src) && !this.editor.uploader ? void(callback && callback(!1)) : this.button.loadImage(this.target, src, function(_this) {
                    return function(img) {
                        var blob;
                        if (img) return _this.active && (_this.width = img.width, _this.height = img.height, _this.widthEl.val(_this.width), _this.heightEl.val(_this.height), _this.target.removeAttr("width").removeAttr("height")), /^data:image/.test(src) ? (blob = _this.editor.util.dataURLtoBlob(src), blob.name = "Base64 Image.png", _this.editor.uploader.upload(blob, {
                            inline: !0,
                            img: _this.target
                        })) : _this.editor.trigger("valuechanged"), callback ? callback(img) : void 0
                    }
                }(this))
            }, ImagePopover.prototype.show = function() {
                var $img, args;
                return args = 1 <= arguments.length ? slice.call(arguments, 0) : [], ImagePopover.__super__.show.apply(this, args), $img = this.target, this.width = $img.width(), this.height = $img.height(), this.alt = $img.attr("alt"), $img.hasClass("uploading") ? this.srcEl.val(this._t("uploading")).prop("disabled", !0) : (this.srcEl.val($img.attr("src")).prop("disabled", !1), this.widthEl.val(this.width), this.heightEl.val(this.height), this.altEl.val(this.alt))
            }, ImagePopover
        }(Popover), Simditor.Toolbar.addButton(ImageButton), IndentButton = function(superClass) {
            function IndentButton() {
                return IndentButton.__super__.constructor.apply(this, arguments)
            }
            return extend(IndentButton, superClass), IndentButton.prototype.name = "indent", IndentButton.prototype.icon = "indent", IndentButton.prototype._init = function() {
                return this.title = this._t(this.name) + " (Tab)", IndentButton.__super__._init.call(this)
            }, IndentButton.prototype.status = function($node) {
                return !0
            }, IndentButton.prototype.command = function() {
                return this.editor.indentation.indent()
            }, IndentButton
        }(Button), Simditor.Toolbar.addButton(IndentButton), OutdentButton = function(superClass) {
            function OutdentButton() {
                return OutdentButton.__super__.constructor.apply(this, arguments)
            }
            return extend(OutdentButton, superClass), OutdentButton.prototype.name = "outdent", OutdentButton.prototype.icon = "outdent", OutdentButton.prototype._init = function() {
                return this.title = this._t(this.name) + " (Shift + Tab)", OutdentButton.__super__._init.call(this)
            }, OutdentButton.prototype.status = function($node) {
                return !0
            }, OutdentButton.prototype.command = function() {
                return this.editor.indentation.indent(!0)
            }, OutdentButton
        }(Button), Simditor.Toolbar.addButton(OutdentButton), HrButton = function(superClass) {
            function HrButton() {
                return HrButton.__super__.constructor.apply(this, arguments)
            }
            return extend(HrButton, superClass), HrButton.prototype.name = "hr", HrButton.prototype.icon = "minus", HrButton.prototype.htmlTag = "hr", HrButton.prototype.status = function($node) {
                return !0
            }, HrButton.prototype.command = function() {
                var $hr, $newBlock, $nextBlock, $rootBlock;
                return $rootBlock = this.editor.util.furthestBlockEl(), $nextBlock = $rootBlock.next(), $nextBlock.length > 0 ? this.editor.selection.save() : $newBlock = $("<p/>").append(this.editor.util.phBr), $hr = $("<hr/>").insertAfter($rootBlock), $newBlock ? ($newBlock.insertAfter($hr), this.editor.selection.setRangeAtStartOf($newBlock)) : this.editor.selection.restore(), this.editor.trigger("valuechanged")
            }, HrButton
        }(Button), Simditor.Toolbar.addButton(HrButton), TableButton = function(superClass) {
            function TableButton() {
                return TableButton.__super__.constructor.apply(this, arguments)
            }
            return extend(TableButton, superClass), TableButton.prototype.name = "table", TableButton.prototype.icon = "table", TableButton.prototype.htmlTag = "table", TableButton.prototype.disableTag = "pre, li, blockquote", TableButton.prototype.menu = !0, TableButton.prototype._init = function() {
                return TableButton.__super__._init.call(this), $.merge(this.editor.formatter._allowedTags, ["thead", "th", "tbody", "tr", "td", "colgroup", "col"]), $.extend(this.editor.formatter._allowedAttributes, {
                    td: ["rowspan", "colspan"],
                    col: ["width"]
                }), this._initShortcuts(), this.editor.on("decorate", function(_this) {
                    return function(e, $el) {
                ...
                }(this)), this.editor.on("selectionchanged.table", function(_this) {
                    return function(e) {
                        var $container, range;
                        return _this.editor.body.find(".simditor-table td, .simditor-table th").removeClass("active"), range = _this.editor.selection.getRange(), null != range ? ($container = $(range.commonAncestorContainer), range.collapsed && $container.is(".simditor-table") && ($container = _this.editor.selection.rangeAtStartOf($container) ? $container.find("th:first") : $container.find("td:last"), _this.editor.selection.setRangeAtEndOf($container)), $container.closest("td, th", _this.editor.body).addClass("active")) : void 0
                    }
                }(this)), this.editor.on("blur.table", function(_this) {
                    return function(e) {
                        return _this.editor.body.find(".simditor-table td, .simditor-table th").removeClass("active")
                    }
                }(this)), this.editor.inputManager.addKeystrokeHandler("38", "td", function(_this) {
                    return function(e, $node) {
                        return _this._tdNav($node, "up"), !0
                    }
                }(this)), this.editor.inputManager.addKeystrokeHandler("38", "th", function(_this) {
                    return function(e, $node) {
                        return _this._tdNav($node, "up"), !0
                    }
                }(this)), this.editor.inputManager.addKeystrokeHandler("40", "td", function(_this) {
                    return function(e, $node) {
                        return _this._tdNav($node, "down"), !0
                    }
                }(this)), this.editor.inputManager.addKeystrokeHandler("40", "th", function(_this) {
                    return function(e, $node) {
                        return _this._tdNav($node, "down"), !0
                    }
                }(this))
                ...
                var $nextTr;
                return $nextTr = $tr.next("tr"), $nextTr.length < 1 && $tr.parent("thead").length > 0 && ($nextTr = $tr.parent("thead").next("tbody").find("tr:first")), $nextTr
            }, TableButton.prototype._prevRow = function($tr) {
                var $prevTr;
                return $prevTr = $tr.prev("tr"), $prevTr.length < 1 && $tr.parent("tbody").length > 0 && ($prevTr = $tr.parent("tbody").prev("thead").find("tr")), $prevTr
            }, TableButton.prototype.initResize = function($table) {
                var $colgroup, $resizeHandle, $wrapper;
                return $wrapper = $table.parent(".simditor-table"), $colgroup = $table.find("colgroup"), $colgroup.length < 1 && ($colgroup = $("<colgroup/>").prependTo($table), $table.find("thead tr th").each(function(_this) {
                    return function(i, td) {
                        var $col;
                        return $col = $("<col/>").appendTo($colgroup)
                    }
                }(this)), this.refreshTableWidth($table)), $resizeHandle = $('<div class="simditor-resize-handle" contenteditable="false"></div>').appendTo($wrapper), $wrapper.on("mousemove", "td, th", function(_this) {
                    return function(e) {
                        var $col, $td, index, ref, ref1, x;
                        if (!$wrapper.hasClass("resizing")) return $td = $(e.currentTarget), x = e.pageX - $(e.currentTarget).offset().left, 5 > x && $td.prev().length > 0 && ($td = $td.prev()), $td.next("td, th").length < 1 ? void $resizeHandle.hide() : (null != (ref = $resizeHandle.data("td")) ? ref.is($td) : void 0) ? void $resizeHandle.show() : (index = $td.parent().find("td, th").index($td), $col = $colgroup.find("col").eq(index), (null != (ref1 = $resizeHandle.data("col")) ? ref1.is($col) : void 0) ? void $resizeHandle.show() : $resizeHandle.css("left", $td.position().left + $td.outerWidth() - 5).data("td", $td).data("col", $col).show())
                    }
                }(this)), $wrapper.on("mouseleave", function(_this) {
                    return function(e) {
                        return $resizeHandle.hide()
                    }
                }(this)), $wrapper.on("mousedown", ".simditor-resize-handle", function(_this) {
                    return function(e) {
                        var $handle, $leftCol, $leftTd, $rightCol, $rightTd, minWidth, startHandleLeft, startLeftWidth, startRightWidth, startX, tableWidth;
                        return $handle = $(e.currentTarget), $leftTd = $handle.data("td"), $leftCol = $handle.data("col"), $rightTd = $leftTd.next("td, th"), $rightCol = $leftCol.next("col"), startX = e.pageX, startLeftWidth = 1 * $leftTd.outerWidth(), startRightWidth = 1 * $rightTd.outerWidth(), startHandleLeft = parseFloat($handle.css("left")), tableWidth = $leftTd.closest("table").width(), minWidth = 50, $(document).on("mousemove.simditor-resize-table", function(e) {
                            var deltaX, leftWidth, rightWidth;
                            return deltaX = e.pageX - startX, leftWidth = startLeftWidth + deltaX, rightWidth = startRightWidth - deltaX, minWidth > leftWidth ? (leftWidth = minWidth, deltaX = minWidth - startLeftWidth, rightWidth = startRightWidth - deltaX) : minWidth > rightWidth && (rightWidth = minWidth, deltaX = startRightWidth - minWidth, leftWidth = startLeftWidth + deltaX), $leftCol.attr("width", leftWidth / tableWidth * 100 + "%"), $rightCol.attr("width", rightWidth / tableWidth * 100 + "%"), $handle.css("left", startHandleLeft + deltaX)
                        }), $(document).one("mouseup.simditor-resize-table", function(e) {
                            return $(document).off(".simditor-resize-table"), $wrapper.removeClass("resizing")
                        }), $wrapper.addClass("resizing"), !1
                    }
                }(this))
            }, TableButton.prototype._initShortcuts = function() {
                return this.editor.inputManager.addShortcut("ctrl+alt+up", function(_this) {
                    return function(e) {
                        return _this.editMenu.find(".menu-item[data-param=insertRowAbove]").click(), !1
                    }
                }(this)), this.editor.inputManager.addShortcut("ctrl+alt+down", function(_this) {
                    return function(e) {
                        return _this.editMenu.find(".menu-item[data-param=insertRowBelow]").click(), !1
                    }
                }(this)), this.editor.inputManager.addShortcut("ctrl+alt+left", function(_this) {
                    return function(e) {
                        return _this.editMenu.find(".menu-item[data-param=insertColLeft]").click(), !1
                    }
                }(this)), this.editor.inputManager.addShortcut("ctrl+alt+right", function(_this) {
                    return function(e) {
                        return _this.editMenu.find(".menu-item[data-param=insertColRight]").click(), !1
                    }
                }(this))
            }, TableButton.prototype.decorate = function($table) {
                return $table.parent(".simditor-table").length > 0 && this.undecorate($table), $table.wrap('<div class="simditor-table"></div>'), this.initResize($table), $table.parent()
            }, TableButton.prototype.undecorate = function($table) {
                return $table.parent(".simditor-table").length > 0 ? $table.parent().replaceWith($table) : void 0
            }, TableButton.prototype.renderMenu = function() {
                var $table;
                return $('<div class="menu-create-table">\n</div>\n<div class="menu-edit-table">\n  <ul>\n    <li><a tabindex="-1" unselectable="on" class="menu-item" href="javascript:;" data-param="deleteRow"><span>' + this._t("deleteRow") + '</span></a></li>\n    <li><a tabindex="-1" unselectable="on" class="menu-item" href="javascript:;" data-param="insertRowAbove"><span>' + this._t("insertRowAbove") + ' ( Ctrl + Alt + ↑ )</span></a></li>\n    <li><a tabindex="-1" unselectable="on" class="menu-item" href="javascript:;" data-param="insertRowBelow"><span>' + this._t("insertRowBelow") + ' ( Ctrl + Alt + ↓ )</span></a></li>\n    <li><span class="separator"></span></li>\n    <li><a tabindex="-1" unselectable="on" class="menu-item" href="javascript:;" data-param="deleteCol"><span>' + this._t("deleteColumn") + '</span></a></li>\n    <li><a tabindex="-1" unselectable="on" class="menu-item" href="javascript:;" data-param="insertColLeft"><span>' + this._t("insertColumnLeft") + ' ( Ctrl + Alt + ← )</span></a></li>\n    <li><a tabindex="-1" unselectable="on" class="menu-item" href="javascript:;" data-param="insertColRight"><span>' + this._t("insertColumnRight") + ' ( Ctrl + Alt + → )</span></a></li>\n    <li><span class="separator"></span></li>\n    <li><a tabindex="-1" unselectable="on" class="menu-item" href="javascript:;" data-param="deleteTable"><span>' + this._t("deleteTable") + "</span></a></li>\n  </ul>\n</div>").appendTo(this.menuWrapper), this.createMenu = this.menuWrapper.find(".menu-create-table"), this.editMenu = this.menuWrapper.find(".menu-edit-table"), $table = this.createTable(6, 6).appendTo(this.createMenu), this.createMenu.on("mouseenter", "td, th", function(_this) {
                    return function(e) {
                        var $td, $tr, $trs, num;
                        return _this.createMenu.find("td, th").removeClass("selected"), $td = $(e.currentTarget), $tr = $td.parent(), num = $tr.find("td, th").index($td) + 1, $trs = $tr.prevAll("tr").addBack(), $tr.parent().is("tbody") && ($trs = $trs.add($table.find("thead tr"))), $trs.find("td:lt(" + num + "), th:lt(" + num + ")").addClass("selected")
                    }
                }(this)), this.createMenu.on("mouseleave", function(_this) {
                    return function(e) {
                        return $(e.currentTarget).find("td, th").removeClass("selected")
                    }
                }(this)), this.createMenu.on("mousedown", "td, th", function(_this) {
                    return function(e) {
                        var $closestBlock, $td, $tr, colNum, rowNum;
                        return _this.wrapper.removeClass("menu-on"), _this.editor.inputManager.focused ? ($td = $(e.currentTarget), $tr = $td.parent(), colNum = $tr.find("td").index($td) + 1, rowNum = $tr.prevAll("tr").length + 1, $tr.parent().is("tbody") && (rowNum += 1), $table = _this.createTable(rowNum, colNum, !0), $closestBlock = _this.editor.util.closestBlockEl(), _this.editor.util.isEmptyNode($closestBlock) ? $closestBlock.replaceWith($table) : $closestBlock.after($table), _this.decorate($table), _this.editor.selection.setRangeAtStartOf($table.find("th:first")), _this.editor.trigger("valuechanged"), !1) : void 0
                    }
                }(this))
            }, TableButton.prototype.createTable = function(row, col, phBr) {
                var $table, $tbody, $td, $thead, $tr, c, j, k, r, ref, ref1;
                for ($table = $("<table/>"), $thead = $("<thead/>").appendTo($table), $tbody = $("<tbody/>").appendTo($table), r = j = 0, ref = row; ref >= 0 ? ref > j : j > ref; r = ref >= 0 ? ++j : --j)
                    for ($tr = $("<tr/>"), $tr.appendTo(0 === r ? $thead : $tbody), c = k = 0, ref1 = col; ref1 >= 0 ? ref1 > k : k > ref1; c = ref1 >= 0 ? ++k : --k) $td = $(0 === r ? "<th/>" : "<td/>").appendTo($tr), phBr && $td.append(this.editor.util.phBr);
                return $table
            }, TableButton.prototype.refreshTableWidth = function($table) {
                var cols, tableWidth;
                return tableWidth = $table.width(), cols = $table.find("col"), $table.find("thead tr th").each(function(_this) {
                    return function(i, td) {
                        var $col;
                        return $col = cols.eq(i), $col.attr("width", $(td).outerWidth() / tableWidth * 100 + "%")
                    }
                }(this))
            }, TableButton.prototype.setActive = function(active) {
                return TableButton.__super__.setActive.call(this, active), active ? (this.createMenu.hide(), this.editMenu.show()) : (this.createMenu.show(), this.editMenu.hide())
            }, TableButton.prototype._changeCellTag = function($tr, tagName) {
                return $tr.find("td, th").each(function(_this) {
                    return function(i, cell) {
                        var $cell;
                        return $cell = $(cell), $cell.replaceWith("<" + tagName + ">" + $cell.html() + "</" + tagName + ">")
                    }
                }(this))
                ...
                for (null == direction && (direction = "after"), $tr = $td.parent("tr"), $table = $tr.closest("table"), colNum = 0, $table.find("tr").each(function(_this) {
                        return function(i, tr) {
                            return colNum = Math.max(colNum, $(tr).find("td").length)
                        }
                    }(this)), index = $tr.find("td, th").index($td), $newTr = $("<tr/>"), cellTag = "td", "after" === direction && $tr.parent().is("thead") ? $tr.parent().next("tbody").prepend($newTr) : "before" === direction && $tr.parent().is("thead") ? ($tr.before($newTr), $tr.parent().next("tbody").prepend($tr), this._changeCellTag($tr, "td"), cellTag = "th") : $tr[direction]($newTr), i = j = 1, ref = colNum; ref >= 1 ? ref >= j : j >= ref; i = ref >= 1 ? ++j : --j) $("<" + cellTag + "/>").append(this.editor.util.phBr).appendTo($newTr);
                return this.editor.selection.setRangeAtStartOf($newTr.find("td, th").eq(index))
            }, TableButton.prototype.deleteCol = function($td) {
                var $newTd, $table, $tr, index;
                return $tr = $td.parent("tr"), $tr.closest("table").find("tr").length < 1 && $td.siblings("td, th").length < 1 ? this.deleteTable($td) : (index = $tr.find("td, th").index($td), $newTd = $td.next("td, th"), $newTd.length > 0 || ($newTd = $tr.prev("td, th")), $table = $tr.closest("table"), $table.find("col").eq(index).remove(), $table.find("tr").each(function(_this) {
                    return function(i, tr) {
                        return $(tr).find("td, th").eq(index).remove()
                    }
                }(this)), this.refreshTableWidth($table), this.editor.selection.setRangeAtEndOf($newTd))
            }, TableButton.prototype.insertCol = function($td, direction) {
                var $col, $newCol, $newTd, $table, $tr, index, tableWidth, width;
                return null == direction && (direction = "after"), $tr = $td.parent("tr"), index = $tr.find("td, th").index($td), $table = $td.closest("table"), $col = $table.find("col").eq(index), $table.find("tr").each(function(_this) {
                    return function(i, tr) {
                        var $newTd, cellTag;
                        return cellTag = $(tr).parent().is("thead") ? "th" : "td", $newTd = $("<" + cellTag + "/>").append(_this.editor.util.phBr), $(tr).find("td, th").eq(index)[direction]($newTd)
                    }
                }(this)), $newCol = $("<col/>"), $col[direction]($newCol), tableWidth = $table.width(), width = Math.max(parseFloat($col.attr("width")) / 2, 50 / tableWidth * 100), $col.attr("width", width + "%"), $newCol.attr("width", width + "%"), this.refreshTableWidth($table), $newTd = "after" === direction ? $td.next("td, th") : $td.prev("td, th"), this.editor.selection.setRangeAtStartOf($newTd)
            }, TableButton.prototype.deleteTable = function($td) {
                var $block, $table;
                return $table = $td.closest(".simditor-table"), $block = $table.next("p"), $table.remove(), $block.length > 0 ? this.editor.selection.setRangeAtStartOf($block) : void 0
            }, TableButton.prototype.command = function(param) {
                var $td, range;
                if (range = this.editor.selection.getRange(), $td = $(range.commonAncestorContainer).closest("td, th"), $td.length > 0) {
                    if ("deleteRow" === param) this.deleteRow($td);
                    else if ("insertRowAbove" === param) this.insertRow($td, "before");
                    else if ("insertRowBelow" === param) this.insertRow($td);
                    else if ("deleteCol" === param) this.deleteCol($td);
                    else if ("insertColLeft" === param) this.insertCol($td, "before");
                    else if ("insertColRight" === param) this.insertCol($td);
                    else {
                        if ("deleteTable" !== param) return;
                        this.deleteTable($td)
                    }
                    return this.editor.trigger("valuechanged")
                }
            }, TableButton
        }(Button), Simditor.Toolbar.addButton(TableButton), StrikethroughButton = function(superClass) {
            function StrikethroughButton() {
                return StrikethroughButton.__super__.constructor.apply(this, arguments)
            }
            return extend(StrikethroughButton, superClass), StrikethroughButton.prototype.name = "strikethrough", StrikethroughButton.prototype.icon = "strikethrough", StrikethroughButton.prototype.htmlTag = "strike", StrikethroughButton.prototype.disableTag = "pre", StrikethroughButton.prototype.status = function($node) {
                var active;
                return null != $node && this.setDisabled($node.is(this.disableTag)), this.disabled ? !0 : (active = document.queryCommandState("strikethrough") === !0, this.setActive(active), active)
            }, StrikethroughButton.prototype.command = function() {
                return document.execCommand("strikethrough"), this.editor.util.support.oninput || this.editor.trigger("valuechanged"), $(document).trigger("selectionchange")
            }, StrikethroughButton
        }(Button), Simditor.Toolbar.addButton(StrikethroughButton), AlignmentButton = function(superClass) {
            function AlignmentButton() {
                return AlignmentButton.__super__.constructor.apply(this, arguments)
            }
            return extend(AlignmentButton, superClass), AlignmentButton.prototype.name = "alignment", AlignmentButton.prototype.icon = "align-left", AlignmentButton.prototype.htmlTag = "p, h1, h2, h3, h4", AlignmentButton.prototype._init = function() {
                return this.menu = [{
                    name: "left",
                ...
                return null == align && (align = "left"), "left" === align ? AlignmentButton.__super__.setActive.call(this, !1) : AlignmentButton.__super__.setActive.call(this, active), this.el.removeClass("align-left align-center align-right"), active && this.el.addClass("align-" + align), this.setIcon("align-" + align), this.menuEl.find(".menu-item").show().end().find(".menu-item-" + align).hide()
            }, AlignmentButton.prototype.status = function($node) {
                if (null == $node) return !0;
                if (this.editor.util.isBlockNode($node)) return this.setDisabled(!$node.is(this.htmlTag)), this.disabled ? (this.setActive(!1), !0) : (this.setActive(!0, $node.data("align")), this.active)
            }, AlignmentButton.prototype.command = function(align) {
                var $blockEls, $endBlock, $startBlock, block, endNode, j, len, range, ref, startNode;
                if (["left", "center", "right"].indexOf(align) < 0) throw "invalid " + align;
                for (range = this.editor.selection.getRange(), startNode = range.startContainer, endNode = range.endContainer, $startBlock = this.editor.util.closestBlockEl(startNode), $endBlock = this.editor.util.closestBlockEl(endNode), this.editor.selection.save(), $blockEls = $startBlock.is($endBlock) ? $startBlock : $startBlock.nextUntil($endBlock).addBack().add($endBlock), ref = $blockEls.filter(this.htmlTag), j = 0, len = ref.length; len > j; j++) block = ref[j], $(block).attr("data-align", align).data("align", align);
                return this.editor.selection.restore(), this.editor.trigger("valuechanged")
            }, AlignmentButton
        }(Button), Simditor.Toolbar.addButton(AlignmentButton), Simditor
    }),
    function() {
        ...
        function Beautifier(js_source_text, options) {
            ...
            function print_token(printable_token) {
                opt.comma_first && "TK_COMMA" === last_type && output.just_added_newline() && "," === output.previous_line.last() && (output.previous_line.pop(), print_token_line_indentation(), output.add_token(","), output.space_before_token = !0), printable_token = printable_token || current_token.text, print_token_line_indentation(), output.add_token(printable_token)
            }
            ...
            function handle_operator() {
                ...
                "TK_OPERATOR" === last_type && allow_wrap_or_preserved_newline();
                var space_before = !0,
                    space_after = !0;
                in_array(current_token.text, ["--", "++", "!", "~"]) || in_array(current_token.text, ["-", "+"]) && (in_array(last_type, ["TK_START_BLOCK", "TK_START_EXPR", "TK_EQUALS", "TK_OPERATOR"]) || in_array(flags.last_text, Tokenizer.line_starters) || "," === flags.last_text) ? (space_before = !1,
                    space_after = !1, !current_token.wanted_newline || "--" !== current_token.text && "++" !== current_token.text || print_newline(!1, !0), ";" === flags.last_text && is_expression(flags.mode) && (space_before = !0), "TK_RESERVED" === last_type ? space_before = !0 : "TK_END_EXPR" === last_type ? space_before = !("]" === flags.last_text && ("--" === current_token.text || "++" === current_token.text)) : "TK_OPERATOR" === last_type && (space_before = in_array(current_token.text, ["--", "-", "++", "+"]) && in_array(flags.last_text, ["--", "-", "++", "+"]), in_array(current_token.text, ["+", "-"]) && in_array(flags.last_text, ["--", "++"]) && (space_after = !0)), flags.mode !== MODE.BlockStatement && flags.mode !== MODE.Statement || "{" !== flags.last_text && ";" !== flags.last_text || print_newline()) : ":" === current_token.text ? 0 === flags.ternary_depth ? space_before = !1 : flags.ternary_depth -= 1 : "?" === current_token.text ? flags.ternary_depth += 1 : "*" === current_token.text && "TK_RESERVED" === last_type && "function" === flags.last_text && (space_before = !1, space_after = !1), output.space_before_token = output.space_before_token || space_before, print_token(), output.space_before_token = space_after
            }
            ...
            for (handlers = {
                    ...
                    TK_EOF: handle_eof
                }, options = options ? options : {}, opt = {}, void 0 !== options.braces_on_own_line && (opt.brace_style = options.braces_on_own_line ? "expand" : "collapse"), opt.brace_style = options.brace_style ? options.brace_style : opt.brace_style ? opt.brace_style : "collapse", "expand-strict" === opt.brace_style && (opt.brace_style = "expand"), opt.indent_size = options.indent_size ? parseInt(options.indent_size, 10) : 4, opt.indent_char = options.indent_char ? options.indent_char : " ", opt.eol = options.eol ? options.eol : "\n", opt.preserve_newlines = void 0 === options.preserve_newlines ? !0 : options.preserve_newlines, opt.break_chained_methods = void 0 === options.break_chained_methods ? !1 : options.break_chained_methods, opt.max_preserve_newlines = void 0 === options.max_preserve_newlines ? 0 : parseInt(options.max_preserve_newlines, 10), opt.space_in_paren = void 0 === options.space_in_paren ? !1 : options.space_in_paren, opt.space_in_empty_paren = void 0 === options.space_in_empty_paren ? !1 : options.space_in_empty_paren, opt.jslint_happy = void 0 === options.jslint_happy ? !1 : options.jslint_happy, opt.space_after_anon_function = void 0 === options.space_after_anon_function ? !1 : options.space_after_anon_function, opt.keep_array_indentation = void 0 === options.keep_array_indentation ? !1 : options.keep_array_indentation, opt.space_before_conditional = void 0 === options.space_before_conditional ? !0 : options.space_before_conditional, opt.unescape_strings = void 0 === options.unescape_strings ? !1 : options.unescape_strings, opt.wrap_line_length = void 0 === options.wrap_line_length ? 0 : parseInt(options.wrap_line_length, 10), opt.e4x = void 0 === options.e4x ? !1 : options.e4x, opt.end_with_newline = void 0 === options.end_with_newline ? !1 : options.end_with_newline, opt.comma_first = void 0 === options.comma_first ? !1 : options.comma_first, opt.jslint_happy && (opt.space_after_anon_function = !0), options.indent_with_tabs && (opt.indent_char = "  ", opt.indent_size = 1), opt.eol = opt.eol.replace(/\\r/, "\r").replace(/\\n/, "\n"), indent_string = ""; opt.indent_size > 0;) indent_string += opt.indent_char, opt.indent_size -= 1;
        ...
        function OutputLine(parent) {
            ...
            this.set_indent = function(level) {
                ...
                var item = null;
                return _empty || (item = _items.pop(), _character_count -= item.length, _empty = 0 === _items.length), item
        ...
        function Output(indent_string, baseIndentString) {
            ...
            var lines = [];
            this.baseIndentString = baseIndentString, this.indent_string = indent_string, this.previous_line = null, this.current_line = null, this.space_before_token = !1, this.get_line_number = function() {
                return lines.length
            }, this.add_new_line = function(force_newline) {
                return 1 === this.get_line_number() && this.just_added_newline() ? !1 : force_newline || !this.just_added_newline() ? (this.previous_line = this.current_line, this.current_line = new OutputLine(this), lines.push(this.current_line), !0) : !1
        ...
        function tokenizer(input, opts, indent_string) {
                ...
                if ("`" === c || "'" === c || '"' === c || ("/" === c || opts.e4x && "<" === c && input.slice(parser_pos - 1).match(/^<([-a-zA-Z:0-9_.]+|{[^{}]*}|!\[CDATA\[[\s\S]*?\]\])(\s+[-a-zA-Z:0-9_.]+\s*=\s*('[^']*'|"[^"]*"|{.*?}))*\s*(\/?)\s*>/)) && ("TK_RESERVED" === last_token.type && in_array(last_token.text, ["return", "case", "throw", "else", "do", "typeof", "yield"]) || "TK_END_EXPR" === last_token.type && ")" === last_token.text && last_token.parent && "TK_RESERVED" === last_token.parent.type && in_array(last_token.parent.text, ["if", "while", "for"]) || in_array(last_token.type, ["TK_COMMENT", "TK_START_EXPR", "TK_START_BLOCK", "TK_END_BLOCK", "TK_OPERATOR", "TK_EQUALS", "TK_EOF", "TK_SEMICOLON", "TK_COMMA"]))) {
                    ...
                    if (resulting_string = c, "/" === sep)
                        ...
                        if (match && 0 === match.index) {
                            ...
                            return xmlStr = xmlStr.slice(0, xmlLength), parser_pos += xmlLength - 1, [xmlStr, "TK_STRING"]
                        }
                    } else
                        for (; input_length > parser_pos && (esc || input.charAt(parser_pos) !== sep && ("`" === sep || !acorn.newline.test(input.charAt(parser_pos))));) resulting_string += input.charAt(parser_pos), "\r" === input.charAt(parser_pos) && "\n" === input.charAt(parser_pos + 1) && (parser_pos += 1, resulting_string += "\n"), esc ? (("x" === input.charAt(parser_pos) || "u" === input.charAt(parser_pos)) && (has_char_escapes = !0), esc = !1) : esc = "\\" === input.charAt(parser_pos), parser_pos += 1;
            ...
            var n_newlines, whitespace_before_token, in_html_comment, tokens, parser_pos, input_length, reserved_words = this.line_starters.concat(["do", "in", "else", "get", "set", "new", "catch", "finally", "typeof", "yield", "async", "await"]);
            this.tokenize = function() {
                ...
                for (var next, last, token_values, open = null, open_stack = [], comments = []; !last || "TK_EOF" !== last.type;) {
                    ...
                    comments.length && (next.comments_before = comments, comments = []), "TK_START_BLOCK" === next.type || "TK_START_EXPR" === next.type ? (next.parent = last, open_stack.push(open), open = next) : ("TK_END_BLOCK" === next.type || "TK_END_EXPR" === next.type) && open && ("]" === next.text && "[" === open.text || ")" === next.text && "(" === open.text || "}" === next.text && "{" === open.text) && (next.parent = open.parent, open = open_stack.pop()), tokens.push(next), last = next
                }
                return tokens
            }
        }
        ...
        var MODE = {
            ...
            Token = function(type, text, newlines, whitespace_before, mode, parent) {
    ...
    function() {
        function css_beautify(source_text, options) {
            ...
            "string" == typeof indentSize && (indentSize = parseInt(indentSize, 10)), options.indent_with_tabs && (indentCharacter = " ", indentSize = 1);
            var ch, whiteRe = /^\s+$/,
                pos = -1,
                parenLevel = 0,
            ...
            for (var output = [], insideRule = !1, enteringConditionalGroup = !1, top_ch = "", last_top_ch = "";;) {
                ...
                if ("/" === ch && "*" === peek()) {
                    ...
                    (isAfterNewline || header) && print.newLine(), output.push(eatComment()), print.newLine(), header && print.newLine(!0)
                    ...
                    variableOrRule.match(/[ :]$/) && (next(), variableOrRule = eatString(": ").replace(/\s$/, ""), output.push(variableOrRule), print.singleSpace()), variableOrRule = variableOrRule.replace(/\s$/, ""), variableOrRule in css_beautify.NESTED_AT_RULE && (nestedLevel += 1, variableOrRule in css_beautify.CONDITIONAL_GROUP_RULE && (enteringConditionalGroup = !0))
                } else "{" === ch ? "}" === peek(!0) ? (eatWhitespace(), next(), print.singleSpace(), output.push("{}"), print.newLine(), newline_between_rules && 0 === indentLevel && print.newLine(!0)) : (indent(), print["{"](ch), enteringConditionalGroup ? (enteringConditionalGroup = !1, insideRule = indentLevel > nestedLevel) : insideRule = indentLevel >= nestedLevel) : "}" === ch ? (outdent(), print["}"](ch), insideRule = !1, nestedLevel && nestedLevel--, newline_between_rules && 0 === indentLevel && print.newLine(!0)) : ":" === ch ? (eatWhitespace(), !insideRule && !enteringConditionalGroup || lookBack("&") || foundNestedPseudoClass() ? ":" === peek() ? (next(), output.push("::")) : output.push(":") : (output.push(":"), print.singleSpace())) : '"' === ch || "'" === ch ? (isAfterSpace && print.singleSpace(), output.push(eatString(ch))) : ";" === ch ? (output.push(ch), print.newLine()) : "(" === ch ? lookBack("url") ? (output.push(ch), eatWhitespace(), next() && (")" !== ch && '"' !== ch && "'" !== ch ? output.push(eatString(")")) : pos--)) : (parenLevel++, isAfterSpace && print.singleSpace(), output.push(ch), eatWhitespace()) : ")" === ch ? (output.push(ch), parenLevel--) : "," === ch ? (output.push(ch), eatWhitespace(), !insideRule && selectorSeparatorNewline && 1 > parenLevel ? print.newLine() : print.singleSpace()) : "]" === ch ? output.push(ch) : "[" === ch ? (isAfterSpace && print.singleSpace(), output.push(ch)) : "=" === ch ? (eatWhitespace(), ch = "=", output.push(ch)) : (isAfterSpace && print.singleSpace(), output.push(ch))
            }
            var sweetCode = "";
            return basebaseIndentString && (sweetCode += basebaseIndentString), sweetCode += output.join("").replace(/[\r\n\t ]+$/, ""), end_with_newline && (sweetCode += "\n"), sweetCode
        }
        ...
        function style_html(html_source, options, js_beautify, css_beautify) {
            function Parser() {
                return this.pos = 0, this.token = "", this.current_mode = "CONTENT", this.tags = {
                    ...
                    whitespace: "\n\r   ".split(""),
                    single_token: "br,input,link,meta,source,!doctype,basefont,base,area,hr,wbr,param,img,isindex,?xml,embed,?php,?,?=".split(","),
                    ...
                    do {
                        ...
                        if (input_char = this.input.charAt(this.pos), this.pos++, this.Utils.in_array(input_char, this.Utils.whitespace)) space = !0;
                            ...
                            if (("'" === input_char || '"' === input_char) && (input_char += this.get_unformatted(input_char), space = !0), "=" === input_char && (space = !1), content.length && "=" !== content[content.length - 1] && ">" !== input_char && space) {
                                if (this.space_or_wrap(content), space = !1, !first_attr && "force" === wrap_attributes && "/" !== input_char) {
                                    this.print_newline(!0, content), this.print_indentation(content);
                                    for (var count = 0; wrap_attributes_indent_size > count; count++) content.push(indent_character)
                                }
                    ...
                    tag_index = -1 !== tag_complete.indexOf(" ") ? tag_complete.indexOf(" ") : "{" === tag_complete[0] ? tag_complete.indexOf("}") : tag_complete.indexOf(">"), tag_offset = "<" !== tag_complete[0] && indent_handlebars ? "#" === tag_complete[2] ? 3 : 2 : 1;
                    ...
                    var comment = "",
                        delimiter = ">",
                        matched = !1;
                    for (this.pos = start_pos, input_char = this.input.charAt(this.pos), this.pos++; this.pos <= this.input.length && (comment += input_char, comment[comment.length - 1] !== delimiter[delimiter.length - 1] || -1 === comment.indexOf(delimiter));) !matched && comment.length < 10 && (0 === comment.indexOf("<![if") ? (delimiter = "<![endif]>", matched = !0) : 0 === comment.indexOf("<![cdata[") ? (delimiter = "]]>", matched = !0) : 0 === comment.indexOf("<![") ? (delimiter = "]>", matched = !0) : 0 === comment.indexOf("<!--") ? (delimiter = "-->", matched = !0) : 0 === comment.indexOf("{{!") && (delimiter = "}}", matched = !0)), input_char = this.input.charAt(this.pos), this.pos++;
                    return comment
                ...
                switch (multi_parser.token_type) {
                    ...
                    case "TK_TAG_END":
                        if ("TK_CONTENT" === multi_parser.last_token && "" === multi_parser.last_text) {
                            ...
                            multi_parser.output.length && (tag_extracted_from_last_output = multi_parser.output[multi_parser.output.length - 1].match(/(?:<|{{#)\s*(\w+)/)), (null === tag_extracted_from_last_output || tag_extracted_from_last_output[1] !== tag_name && !multi_parser.Utils.in_array(tag_extracted_from_last_output[1], unformatted)) && multi_parser.print_newline(!1, multi_parser.output)
                        }
    ...
    function(root, factory) {
        "function" == typeof define && define.amd ? define("simditor-html", ["jquery", "simditor", "html_beautify"], function(a0, b1, c2) {
            return root.HTMLButton = factory(a0, b1, c2)
        }) : "object" == typeof exports ? module.exports = factory(require("jquery"), require("simditor"), require("js_beautify")) : root.SimditorHTML = factory(jQuery, Simditor, html_beautify)
    }(this, function($, Simditor, beautify) {
        var HTMLButton, extend = function(child, parent) {
                function ctor() {
                    this.constructor = child
                }
                for (var key in parent) hasProp.call(parent, key) && (child[key] = parent[key]);
            ...
            hasProp = {}.hasOwnProperty,
            slice = [].slice;
        return HTMLButton = function(superClass) {
            function HTMLButton() {
                return HTMLButton.__super__.constructor.apply(this, arguments)
            }
            return extend(HTMLButton, superClass), HTMLButton.prototype.name = "html", HTMLButton.prototype.icon = "html5", HTMLButton.prototype.needFocus = !1, HTMLButton.prototype._init = function() {
                return HTMLButton.__super__._init.call(this), this.editor.textarea.on("focus", function(_this) {
                    return function(e) {
                        return _this.editor.el.addClass("focus").removeClass("error")
                    }
                }(this)), this.editor.textarea.on("blur", function(_this) {
                    return function(e) {
                        return _this.editor.el.removeClass("focus"), _this.editor.setValue(_this.editor.textarea.val()), _this.editor.trigger("valuechanged")
                    }
                }(this)), this.editor.textarea.on("input", function(_this) {
                    return function(e) {
                ...
                for (this.editor.blur(), this.editor.el.toggleClass("simditor-html"), this.editor.htmlMode = this.editor.el.hasClass("simditor-html"), this.editor.htmlMode && (this.editor.hidePopover(), this.editor.textarea.val(this.beautifyHTML(this.editor.textarea.val())), this._resizeTextarea()), ref = this.editor.toolbar.buttons, i = 0, len = ref.length; len > i; i++) button = ref[i], "html" === button.name ? button.setActive(this.editor.htmlMode) : button.setDisabled(this.editor.htmlMode);
                return null
            }, HTMLButton.prototype.beautifyHTML = function() {
                var args;
                return args = 1 <= arguments.length ? slice.call(arguments, 0) : [], beautify.html ? beautify.html.apply(beautify, args) : beautify.apply(null, args)
            }, HTMLButton.prototype._resizeTextarea = function() {
                return this._textareaPadding || (this._textareaPadding = this.editor.textarea.innerHeight() - this.editor.textarea.height()), this.editor.textarea.height(0).height(this.editor.textarea[0].scrollHeight - this._textareaPadding)
            }, HTMLButton
        }(Simditor.Button), Simditor.Toolbar.addButton(HTMLButton), HTMLButton
    });